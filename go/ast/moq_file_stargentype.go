...
// The following type assertion assures that ast.File_starGenType is mocked
// completely
...
type MoqFile_starGenType struct {
	...
	ResultsByParams_End []MoqFile_starGenType_End_resultsByParams
...
type MoqFile_starGenType_Pos_params struct{}
...
type MoqFile_starGenType_Pos_doFn func()
...
type MoqFile_starGenType_Pos_doReturnFn func() token.Pos
...
// MoqFile_starGenType_End_params holds the params of the File_starGenType type
type MoqFile_starGenType_End_params struct{}

// MoqFile_starGenType_End_paramsKey holds the map key params of the
// File_starGenType type
type MoqFile_starGenType_End_paramsKey struct {
	Params struct{}
	Hashes struct{}
}

// MoqFile_starGenType_End_resultsByParams contains the results for a given set
// of parameters for the File_starGenType type
type MoqFile_starGenType_End_resultsByParams struct {
	AnyCount  int
	AnyParams uint64
	Results   map[MoqFile_starGenType_End_paramsKey]*MoqFile_starGenType_End_results
}

// MoqFile_starGenType_End_doFn defines the type of function needed when
// calling AndDo for the File_starGenType type
type MoqFile_starGenType_End_doFn func()

// MoqFile_starGenType_End_doReturnFn defines the type of function needed when
// calling DoReturnResults for the File_starGenType type
type MoqFile_starGenType_End_doReturnFn func() token.Pos

// MoqFile_starGenType_End_results holds the results of the File_starGenType
// type
type MoqFile_starGenType_End_results struct {
	Params  MoqFile_starGenType_End_params
	Results []struct {
		Values *struct {
			Result1 token.Pos
		}
		Sequence   uint32
		DoFn       MoqFile_starGenType_End_doFn
		DoReturnFn MoqFile_starGenType_End_doReturnFn
	}
	Index  uint32
	Repeat *moq.RepeatVal
}

// MoqFile_starGenType_End_fnRecorder routes recorded function calls to the
// MoqFile_starGenType moq
type MoqFile_starGenType_End_fnRecorder struct {
	Params    MoqFile_starGenType_End_params
	AnyParams uint64
	Sequence  bool
	Results   *MoqFile_starGenType_End_results
	Moq       *MoqFile_starGenType
}

// MoqFile_starGenType_End_anyParams isolates the any params functions of the
// File_starGenType type
type MoqFile_starGenType_End_anyParams struct {
	Recorder *MoqFile_starGenType_End_fnRecorder
}
...
func (m *MoqFile_starGenType_mock) Pos() (result1 token.Pos) {
...
func (m *MoqFile_starGenType_mock) End() (result1 token.Pos) {
	m.Moq.Scene.T.Helper()
	params := MoqFile_starGenType_End_params{}
	var results *MoqFile_starGenType_End_results
...
func (m *MoqFile_starGenType_recorder) Pos() *MoqFile_starGenType_Pos_fnRecorder {
...
func (m *MoqFile_starGenType_recorder) End() *MoqFile_starGenType_End_fnRecorder {
	return &MoqFile_starGenType_End_fnRecorder{
		Params:   MoqFile_starGenType_End_params{},
		Sequence: m.Moq.Config.Sequence == moq.SeqDefaultOn,
		Moq:      m.Moq,
	}
...
func (r *MoqFile_starGenType_End_fnRecorder) Any() *MoqFile_starGenType_End_anyParams {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
	...
	return &MoqFile_starGenType_End_anyParams{Recorder: r}
}

func (r *MoqFile_starGenType_End_fnRecorder) Seq() *MoqFile_starGenType_End_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqFile_starGenType_End_fnRecorder) NoSeq() *MoqFile_starGenType_End_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqFile_starGenType_End_fnRecorder) ReturnResults(result1 token.Pos) *MoqFile_starGenType_End_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqFile_starGenType_End_fnRecorder) AndDo(fn MoqFile_starGenType_End_doFn) *MoqFile_starGenType_End_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults must be called before calling AndDo")
		return nil
...
func (r *MoqFile_starGenType_End_fnRecorder) DoReturnResults(fn MoqFile_starGenType_End_doReturnFn) *MoqFile_starGenType_End_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqFile_starGenType_End_fnRecorder) FindResults() {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Results.Repeat.Increment(r.Moq.Scene.T)
		return
	...
	anyCount := bits.OnesCount64(r.AnyParams)
	insertAt := -1
	var results *MoqFile_starGenType_End_resultsByParams
	...
	if results == nil {
		results = &MoqFile_starGenType_End_resultsByParams{
			AnyCount:  anyCount,
			AnyParams: r.AnyParams,
			Results:   map[MoqFile_starGenType_End_paramsKey]*MoqFile_starGenType_End_results{},
		}
	...
	r.Results, ok = results.Results[paramsKey]
	if !ok {
		r.Results = &MoqFile_starGenType_End_results{
			Params:  r.Params,
			Results: nil,
			Index:   0,
			Repeat:  &moq.RepeatVal{},
...
func (r *MoqFile_starGenType_End_fnRecorder) Repeat(repeaters ...moq.Repeater) *MoqFile_starGenType_End_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults or DoReturnResults must be called before calling Repeat")
		return nil
...
func (m *MoqFile_starGenType) PrettyParams_End(params MoqFile_starGenType_End_params) string {
	return fmt.Sprintf("End()")
}

func (m *MoqFile_starGenType) ParamsKey_End(params MoqFile_starGenType_End_params, anyParams uint64) MoqFile_starGenType_End_paramsKey {
	m.Scene.T.Helper()
	return MoqFile_starGenType_End_paramsKey{
		Params: struct{}{},
		Hashes: struct{}{},
	}
}
...
func (m *MoqFile_starGenType) Reset() { m.ResultsByParams_Pos = nil; m.ResultsByParams_End = nil }
