...
type Default_genType func() types.Importer
...
type MoqDefault_genType_params struct{}
...
type MoqDefault_genType_doFn func()
...
type MoqDefault_genType_doReturnFn func() types.Importer
...
func (m *MoqDefault_genType) Mock() Default_genType {
	return func() types.Importer { m.Scene.T.Helper(); moq := &MoqDefault_genType_mock{Moq: m}; return moq.Fn() }
}

func (m *MoqDefault_genType_mock) Fn() (result1 types.Importer) {
...
func (m *MoqDefault_genType) OnCall() *MoqDefault_genType_fnRecorder {
...
func (r *MoqDefault_genType_fnRecorder) ReturnResults(result1 types.Importer) *MoqDefault_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqDefault_genType) PrettyParams(params MoqDefault_genType_params) string {
	return fmt.Sprintf("Default_genType()")
}
