...
// The following type assertion assures that fs.FileInfo is mocked completely
var _ fs.FileInfo = (*MoqFileInfo_mock)(nil)
...
// DoReturnResults for the FileInfo type
type MoqFileInfo_Mode_doReturnFn func() fs.FileMode
...
func (m *MoqFileInfo_mock) Mode() (result1 fs.FileMode) {
	m.Moq.Scene.T.Helper()
	params := MoqFileInfo_Mode_params{}
...
func (r *MoqFileInfo_Mode_fnRecorder) ReturnResults(result1 fs.FileMode) *MoqFileInfo_Mode_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
