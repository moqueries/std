...
type Stat_genType func(fsys fs.FS, name string) (fs.FileInfo, error)
...
type MoqStat_genType_doFn func(fsys fs.FS, name string)

// MoqStat_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Stat_genType type
type MoqStat_genType_doReturnFn func(fsys fs.FS, name string) (fs.FileInfo, error)
...
func (m *MoqStat_genType) Mock() Stat_genType {
	return func(fsys fs.FS, name string) (fs.FileInfo, error) {
		m.Scene.T.Helper()
...
func (m *MoqStat_genType_mock) Fn(fsys fs.FS, name string) (result1 fs.FileInfo, result2 error) {
...
func (m *MoqStat_genType) OnCall(fsys fs.FS, name string) *MoqStat_genType_fnRecorder {
...
func (a *MoqStat_genType_anyParams) Fsys() *MoqStat_genType_fnRecorder {
...
func (r *MoqStat_genType_fnRecorder) ReturnResults(result1 fs.FileInfo, result2 error) *MoqStat_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqStat_genType) PrettyParams(params MoqStat_genType_params) string {
	return fmt.Sprintf("Stat_genType(%#v, %#v)", params.Fsys, params.Name)
}
