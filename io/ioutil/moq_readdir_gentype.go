...
type MoqReadDir_genType_doFn func(dirname string)
...
func (m *MoqReadDir_genType_mock) Fn(dirname string) (result1 []os.FileInfo, result2 error) {
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(dirname)
	}
	return
}

func (m *MoqReadDir_genType) OnCall(dirname string) *MoqReadDir_genType_fnRecorder {
...
func (a *MoqReadDir_genType_anyParams) Dirname() *MoqReadDir_genType_fnRecorder {
...
func (m *MoqReadDir_genType) PrettyParams(params MoqReadDir_genType_params) string {
	return fmt.Sprintf("ReadDir_genType(%#v)", params.Dirname)
}

func (m *MoqReadDir_genType) ParamsKey(params MoqReadDir_genType_params, anyParams uint64) MoqReadDir_genType_paramsKey {
	m.Scene.T.Helper()
	var dirnameUsed string
	var dirnameUsedHash hash.Hash
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.Dirname == moq.ParamIndexByValue {
			dirnameUsed = params.Dirname
		} else {
			dirnameUsedHash = hash.DeepHash(params.Dirname)
		}
	}
