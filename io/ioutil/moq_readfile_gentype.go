...
type ReadFile_genType func(filename string) ([]byte, error)
...
type MoqReadFile_genType_params struct{ Filename string }
...
type MoqReadFile_genType_paramsKey struct {
	Params struct{ Filename string }
	Hashes struct{ Filename hash.Hash }
}
...
type MoqReadFile_genType_doFn func(filename string)
...
type MoqReadFile_genType_doReturnFn func(filename string) ([]byte, error)
...
func (m *MoqReadFile_genType) Mock() ReadFile_genType {
	return func(filename string) ([]byte, error) {
		...
		return moq.Fn(filename)
	}
}

func (m *MoqReadFile_genType_mock) Fn(filename string) (result1 []byte, result2 error) {
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(filename)
	}
	return
}

func (m *MoqReadFile_genType) OnCall(filename string) *MoqReadFile_genType_fnRecorder {
...
func (a *MoqReadFile_genType_anyParams) Filename() *MoqReadFile_genType_fnRecorder {
...
func (m *MoqReadFile_genType) PrettyParams(params MoqReadFile_genType_params) string {
	return fmt.Sprintf("ReadFile_genType(%#v)", params.Filename)
}
