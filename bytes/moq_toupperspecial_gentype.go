...
type ToUpperSpecial_genType func(c unicode.SpecialCase, s []byte) []byte
...
type MoqToUpperSpecial_genType_doFn func(c unicode.SpecialCase, s []byte)
...
type MoqToUpperSpecial_genType_doReturnFn func(c unicode.SpecialCase, s []byte) []byte
...
func (m *MoqToUpperSpecial_genType_mock) Fn(c unicode.SpecialCase, s []byte) (result1 []byte) {
...
func (m *MoqToUpperSpecial_genType) OnCall(c unicode.SpecialCase, s []byte) *MoqToUpperSpecial_genType_fnRecorder {
...
func (r *MoqToUpperSpecial_genType_fnRecorder) ReturnResults(result1 []byte) *MoqToUpperSpecial_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
