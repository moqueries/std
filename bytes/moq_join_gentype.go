...
type Join_genType func(s [][]byte, sep []byte) []byte
...
func (m *MoqJoin_genType) Mock() Join_genType {
	return func(s [][]byte, sep []byte) []byte {
		m.Scene.T.Helper()
...
func (m *MoqJoin_genType_mock) Fn(s [][]byte, sep []byte) (result1 []byte) {
...
func (m *MoqJoin_genType) OnCall(s [][]byte, sep []byte) *MoqJoin_genType_fnRecorder {
...
func (a *MoqJoin_genType_anyParams) S() *MoqJoin_genType_fnRecorder {
...
func (r *MoqJoin_genType_fnRecorder) ReturnResults(result1 []byte) *MoqJoin_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqJoin_genType) PrettyParams(params MoqJoin_genType_params) string {
	return fmt.Sprintf("Join_genType(%#v, %#v)", params.S, params.Sep)
}
