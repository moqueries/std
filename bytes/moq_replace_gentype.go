...
type Replace_genType func(s, old, new []byte, n int) []byte
...
type MoqReplace_genType_doFn func(s, old, new []byte, n int)
...
type MoqReplace_genType_doReturnFn func(s, old, new []byte, n int) []byte
...
func (m *MoqReplace_genType) Mock() Replace_genType {
	return func(s, old, new []byte, n int) []byte {
		m.Scene.T.Helper()
...
func (m *MoqReplace_genType_mock) Fn(s, old, new []byte, n int) (result1 []byte) {
...
func (m *MoqReplace_genType) OnCall(s, old, new []byte, n int) *MoqReplace_genType_fnRecorder {
...
func (r *MoqReplace_genType_fnRecorder) ReturnResults(result1 []byte) *MoqReplace_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
