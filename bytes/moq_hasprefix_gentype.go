...
type HasPrefix_genType func(s, prefix []byte) bool
...
type MoqHasPrefix_genType_params struct{ S, Prefix []byte }
...
type MoqHasPrefix_genType_doFn func(s, prefix []byte)
...
type MoqHasPrefix_genType_doReturnFn func(s, prefix []byte) bool
...
func (m *MoqHasPrefix_genType) Mock() HasPrefix_genType {
	return func(s, prefix []byte) bool {
		m.Scene.T.Helper()
...
func (m *MoqHasPrefix_genType_mock) Fn(s, prefix []byte) (result1 bool) {
...
func (m *MoqHasPrefix_genType) OnCall(s, prefix []byte) *MoqHasPrefix_genType_fnRecorder {
