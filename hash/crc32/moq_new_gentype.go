...
type New_genType func(tab *crc32.Table) hash.Hash32
...
type MoqNew_genType_params struct{ Tab *crc32.Table }
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(tab *crc32.Table) hash.Hash32 {
		m.Scene.T.Helper()
...
func (m *MoqNew_genType_mock) Fn(tab *crc32.Table) (result1 hash.Hash32) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(tab)
	}
	return
}

func (m *MoqNew_genType) OnCall(tab *crc32.Table) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Tab() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 hash.Hash32) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v)", params.Tab)
}
...
func (m *MoqNew_genType) ParamsKey(params MoqNew_genType_params, anyParams uint64) MoqNew_genType_paramsKey {
	...
	var tabUsedHash hash1.Hash
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.Tab == moq.ParamIndexByValue {
			tabUsed = params.Tab
		} else {
			tabUsedHash = hash1.DeepHash(params.Tab)
		}
	}
