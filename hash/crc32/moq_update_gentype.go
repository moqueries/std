...
type Update_genType func(crc uint32, tab *crc32.Table, p []byte) uint32
...
type MoqUpdate_genType_doFn func(crc uint32, tab *crc32.Table, p []byte)

// MoqUpdate_genType_doReturnFn defines the type of function needed when
// calling DoReturnResults for the Update_genType type
type MoqUpdate_genType_doReturnFn func(crc uint32, tab *crc32.Table, p []byte) uint32
...
func (m *MoqUpdate_genType) Mock() Update_genType {
	return func(crc uint32, tab *crc32.Table, p []byte) uint32 {
		m.Scene.T.Helper()
...
func (m *MoqUpdate_genType_mock) Fn(crc uint32, tab *crc32.Table, p []byte) (result1 uint32) {
...
func (m *MoqUpdate_genType) OnCall(crc uint32, tab *crc32.Table, p []byte) *MoqUpdate_genType_fnRecorder {
...
func (r *MoqUpdate_genType_fnRecorder) ReturnResults(result1 uint32) *MoqUpdate_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
