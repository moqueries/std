...
type New_genType func(tab *crc64.Table) hash.Hash64
...
type MoqNew_genType_params struct{ Tab *crc64.Table }
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(tab *crc64.Table) hash.Hash64 {
		m.Scene.T.Helper()
...
func (m *MoqNew_genType_mock) Fn(tab *crc64.Table) (result1 hash.Hash64) {
...
func (m *MoqNew_genType) OnCall(tab *crc64.Table) *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 hash.Hash64) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
