...
type MakeTable_genType func(poly uint64) *crc64.Table
...
type MoqMakeTable_genType_doFn func(poly uint64)
...
type MoqMakeTable_genType_doReturnFn func(poly uint64) *crc64.Table
...
func (m *MoqMakeTable_genType) Mock() MakeTable_genType {
	return func(poly uint64) *crc64.Table {
		m.Scene.T.Helper()
...
func (m *MoqMakeTable_genType_mock) Fn(poly uint64) (result1 *crc64.Table) {
...
func (m *MoqMakeTable_genType) OnCall(poly uint64) *MoqMakeTable_genType_fnRecorder {
...
func (r *MoqMakeTable_genType_fnRecorder) ReturnResults(result1 *crc64.Table) *MoqMakeTable_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
