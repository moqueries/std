...
type New_genType func() hash.Hash32
...
func (m *MoqNew_genType) Mock() New_genType {
	return func() hash.Hash32 { m.Scene.T.Helper(); moq := &MoqNew_genType_mock{Moq: m}; return moq.Fn() }
}

func (m *MoqNew_genType_mock) Fn() (result1 hash.Hash32) {
...
func (m *MoqNew_genType) OnCall() *MoqNew_genType_fnRecorder {
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType()")
}
