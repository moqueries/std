...
type NewEncoder_genType func(w io.Writer) *xml.Encoder
...
type MoqNewEncoder_genType_doReturnFn func(w io.Writer) *xml.Encoder
...
func (m *MoqNewEncoder_genType) Mock() NewEncoder_genType {
	return func(w io.Writer) *xml.Encoder {
		m.Scene.T.Helper()
...
func (m *MoqNewEncoder_genType_mock) Fn(w io.Writer) (result1 *xml.Encoder) {
...
func (r *MoqNewEncoder_genType_fnRecorder) ReturnResults(result1 *xml.Encoder) *MoqNewEncoder_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
