...
type NewEncoder_genType func(w io.Writer) *gob.Encoder
...
type MoqNewEncoder_genType_doReturnFn func(w io.Writer) *gob.Encoder
...
func (m *MoqNewEncoder_genType) Mock() NewEncoder_genType {
	return func(w io.Writer) *gob.Encoder {
		m.Scene.T.Helper()
...
func (m *MoqNewEncoder_genType_mock) Fn(w io.Writer) (result1 *gob.Encoder) {
...
func (r *MoqNewEncoder_genType_fnRecorder) ReturnResults(result1 *gob.Encoder) *MoqNewEncoder_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
