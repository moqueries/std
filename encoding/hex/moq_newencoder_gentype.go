...
type NewEncoder_genType func(w io.Writer) io.Writer
...
type MoqNewEncoder_genType_doReturnFn func(w io.Writer) io.Writer
...
func (m *MoqNewEncoder_genType_mock) Fn(w io.Writer) (result1 io.Writer) {
...
func (r *MoqNewEncoder_genType_fnRecorder) ReturnResults(result1 io.Writer) *MoqNewEncoder_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
