...
type Encode_genType func(dst, src []byte) int
...
type MoqEncode_genType_params struct{ Dst, Src []byte }
...
func (m *MoqEncode_genType_mock) Fn(dst, src []byte) (result1 int) {
...
func (m *MoqEncode_genType) OnCall(dst, src []byte) *MoqEncode_genType_fnRecorder {
...
func (a *MoqEncode_genType_anyParams) Dst() *MoqEncode_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqEncode_genType_anyParams) Src() *MoqEncode_genType_fnRecorder {
...
func (r *MoqEncode_genType_fnRecorder) ReturnResults(result1 int) *MoqEncode_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqEncode_genType) PrettyParams(params MoqEncode_genType_params) string {
	return fmt.Sprintf("Encode_genType(%#v, %#v)", params.Dst, params.Src)
}
