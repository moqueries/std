...
type NewEncoder_genType func(w io.Writer) io.WriteCloser
...
type MoqNewEncoder_genType_doReturnFn func(w io.Writer) io.WriteCloser
...
func (m *MoqNewEncoder_genType_mock) Fn(w io.Writer) (result1 io.WriteCloser) {
