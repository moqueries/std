...
type Encode_genType func(out io.Writer, b *pem.Block) error
...
type MoqEncode_genType_doFn func(out io.Writer, b *pem.Block)

// MoqEncode_genType_doReturnFn defines the type of function needed when
// calling DoReturnResults for the Encode_genType type
type MoqEncode_genType_doReturnFn func(out io.Writer, b *pem.Block) error
...
func (m *MoqEncode_genType) Mock() Encode_genType {
	return func(out io.Writer, b *pem.Block) error {
		m.Scene.T.Helper()
...
func (m *MoqEncode_genType_mock) Fn(out io.Writer, b *pem.Block) (result1 error) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(out, b)
	}
	return
}

func (m *MoqEncode_genType) OnCall(out io.Writer, b *pem.Block) *MoqEncode_genType_fnRecorder {
...
func (a *MoqEncode_genType_anyParams) Out() *MoqEncode_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqEncode_genType_anyParams) B() *MoqEncode_genType_fnRecorder {
...
func (m *MoqEncode_genType) PrettyParams(params MoqEncode_genType_params) string {
	return fmt.Sprintf("Encode_genType(%#v, %#v)", params.Out, params.B)
}
