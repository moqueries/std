...
type NewEncoder_genType func(enc *base32.Encoding, w io.Writer) io.WriteCloser
...
type MoqNewEncoder_genType_doFn func(enc *base32.Encoding, w io.Writer)
...
type MoqNewEncoder_genType_doReturnFn func(enc *base32.Encoding, w io.Writer) io.WriteCloser
...
func (m *MoqNewEncoder_genType) Mock() NewEncoder_genType {
	return func(enc *base32.Encoding, w io.Writer) io.WriteCloser {
		m.Scene.T.Helper()
...
func (m *MoqNewEncoder_genType_mock) Fn(enc *base32.Encoding, w io.Writer) (result1 io.WriteCloser) {
...
func (m *MoqNewEncoder_genType) OnCall(enc *base32.Encoding, w io.Writer) *MoqNewEncoder_genType_fnRecorder {
