...
// The following type assertion assures that base32.Encoding_genType is mocked
// completely
...
type MoqEncoding_genType_WithPadding_doReturnFn func(padding rune) *base32.Encoding
...
func (m *MoqEncoding_genType_mock) WithPadding(padding rune) (result1 *base32.Encoding) {
...
func (r *MoqEncoding_genType_WithPadding_fnRecorder) ReturnResults(result1 *base32.Encoding) *MoqEncoding_genType_WithPadding_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqEncoding_genType) Reset() { m.ResultsByParams_WithPadding = nil }
