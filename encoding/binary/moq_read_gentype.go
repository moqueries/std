...
func (m *MoqRead_genType_mock) Fn(param1 io.Reader, order binary.ByteOrder, data interface{}) (result1 error) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(param1, order, data)
	}
	return
}
...
func (a *MoqRead_genType_anyParams) Order() *MoqRead_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqRead_genType_anyParams) Data() *MoqRead_genType_fnRecorder {
...
func (r *MoqRead_genType_fnRecorder) ReturnResults(result1 error) *MoqRead_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqRead_genType) PrettyParams(params MoqRead_genType_params) string {
	return fmt.Sprintf("Read_genType(%#v, %#v, %#v)", params.Param1, params.Order, params.Data)
}
