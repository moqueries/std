...
type ReplaceAll_genType func(s, old, new string) string
...
type MoqReplaceAll_genType_doFn func(s, old, new string)
...
type MoqReplaceAll_genType_doReturnFn func(s, old, new string) string
...
func (m *MoqReplaceAll_genType) Mock() ReplaceAll_genType {
	return func(s, old, new string) string {
		m.Scene.T.Helper()
...
func (m *MoqReplaceAll_genType_mock) Fn(s, old, new string) (result1 string) {
...
func (m *MoqReplaceAll_genType) OnCall(s, old, new string) *MoqReplaceAll_genType_fnRecorder {
...
func (r *MoqReplaceAll_genType_fnRecorder) ReturnResults(result1 string) *MoqReplaceAll_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
