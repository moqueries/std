...
// The following type assertion assures that strings.Reader_starGenType is
// mocked completely
...
// Reader_starGenType type
type MoqReader_starGenType_Reset_params struct{ S string }
...
// calling AndDo for the Reader_starGenType type
type MoqReader_starGenType_Reset_doFn func(s string)

// MoqReader_starGenType_Reset_doReturnFn defines the type of function needed
// when calling DoReturnResults for the Reader_starGenType type
type MoqReader_starGenType_Reset_doReturnFn func(s string)
...
func (m *MoqReader_starGenType_mock) Reset(s string) {
	m.Moq.Scene.T.Helper()
	params := MoqReader_starGenType_Reset_params{
		S: s,
	}
...
func (m *MoqReader_starGenType_recorder) Reset(s string) *MoqReader_starGenType_Reset_fnRecorder {
...
func (a *MoqReader_starGenType_Reset_anyParams) S() *MoqReader_starGenType_Reset_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}
...
func (m *MoqReader_starGenType) PrettyParams_Reset(params MoqReader_starGenType_Reset_params) string {
	return fmt.Sprintf("Reset(%#v)", params.S)
}
...
func (m *MoqReader_starGenType) ParamsKey_Reset(params MoqReader_starGenType_Reset_params, anyParams uint64) MoqReader_starGenType_Reset_paramsKey {
	...
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.Reset.S == moq.ParamIndexByValue {
			sUsed = params.S
		} else {
