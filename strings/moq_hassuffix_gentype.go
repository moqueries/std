...
type HasSuffix_genType func(s, suffix string) bool
...
type MoqHasSuffix_genType_params struct{ S, Suffix string }
...
type MoqHasSuffix_genType_doFn func(s, suffix string)
...
type MoqHasSuffix_genType_doReturnFn func(s, suffix string) bool
...
func (m *MoqHasSuffix_genType_mock) Fn(s, suffix string) (result1 bool) {
...
func (m *MoqHasSuffix_genType) OnCall(s, suffix string) *MoqHasSuffix_genType_fnRecorder {
