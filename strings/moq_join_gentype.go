...
type Join_genType func(elems []string, sep string) string
...
type MoqJoin_genType_params struct {
	Elems []string
	Sep   string
}
...
type MoqJoin_genType_doFn func(elems []string, sep string)

// MoqJoin_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Join_genType type
type MoqJoin_genType_doReturnFn func(elems []string, sep string) string
...
func (m *MoqJoin_genType) Mock() Join_genType {
	return func(elems []string, sep string) string {
		...
		return moq.Fn(elems, sep)
	}
}

func (m *MoqJoin_genType_mock) Fn(elems []string, sep string) (result1 string) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(elems, sep)
	}
	return
}

func (m *MoqJoin_genType) OnCall(elems []string, sep string) *MoqJoin_genType_fnRecorder {
...
func (a *MoqJoin_genType_anyParams) Elems() *MoqJoin_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqJoin_genType_anyParams) Sep() *MoqJoin_genType_fnRecorder {
...
func (m *MoqJoin_genType) PrettyParams(params MoqJoin_genType_params) string {
	return fmt.Sprintf("Join_genType(%#v, %#v)", params.Elems, params.Sep)
}

func (m *MoqJoin_genType) ParamsKey(params MoqJoin_genType_params, anyParams uint64) MoqJoin_genType_paramsKey {
	m.Scene.T.Helper()
	var elemsUsedHash hash.Hash
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.Elems == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The elems parameter can't be indexed by value")
		}
		elemsUsedHash = hash.DeepHash(params.Elems)
	}
	var sepUsed string
