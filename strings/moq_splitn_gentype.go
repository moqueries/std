...
type SplitN_genType func(s, sep string, n int) []string
...
func (m *MoqSplitN_genType_mock) Fn(s, sep string, n int) (result1 []string) {
...
func (m *MoqSplitN_genType) OnCall(s, sep string, n int) *MoqSplitN_genType_fnRecorder {
...
func (r *MoqSplitN_genType_fnRecorder) ReturnResults(result1 []string) *MoqSplitN_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
