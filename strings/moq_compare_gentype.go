...
type Compare_genType func(a, b string) int
...
type MoqCompare_genType_doFn func(a, b string)
...
type MoqCompare_genType_doReturnFn func(a, b string) int
...
func (m *MoqCompare_genType_mock) Fn(a, b string) (result1 int) {
...
func (m *MoqCompare_genType) OnCall(a, b string) *MoqCompare_genType_fnRecorder {
