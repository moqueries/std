...
type HasPrefix_genType func(p, prefix string) bool
...
type MoqHasPrefix_genType_params struct{ P, Prefix string }

// MoqHasPrefix_genType_paramsKey holds the map key params of the
// HasPrefix_genType type
type MoqHasPrefix_genType_paramsKey struct {
	Params struct{ P, Prefix string }
	Hashes struct{ P, Prefix hash.Hash }
}
...
type MoqHasPrefix_genType_doFn func(p, prefix string)
...
type MoqHasPrefix_genType_doReturnFn func(p, prefix string) bool
...
func (m *MoqHasPrefix_genType) Mock() HasPrefix_genType {
	return func(p, prefix string) bool {
		m.Scene.T.Helper()
		moq := &MoqHasPrefix_genType_mock{Moq: m}
		return moq.Fn(p, prefix)
	}
}

func (m *MoqHasPrefix_genType_mock) Fn(p, prefix string) (result1 bool) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(p, prefix)
	}
	return
}

func (m *MoqHasPrefix_genType) OnCall(p, prefix string) *MoqHasPrefix_genType_fnRecorder {
...
func (a *MoqHasPrefix_genType_anyParams) P() *MoqHasPrefix_genType_fnRecorder {
...
func (m *MoqHasPrefix_genType) PrettyParams(params MoqHasPrefix_genType_params) string {
	return fmt.Sprintf("HasPrefix_genType(%#v, %#v)", params.P, params.Prefix)
}
