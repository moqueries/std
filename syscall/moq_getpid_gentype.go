...
type Getpid_genType func() (pid int)
...
type MoqGetpid_genType_doReturnFn func() (pid int)
...
func (m *MoqGetpid_genType) Mock() Getpid_genType {
	return func() (_ int) { m.Scene.T.Helper(); moq := &MoqGetpid_genType_mock{Moq: m}; return moq.Fn() }
}

func (m *MoqGetpid_genType_mock) Fn() (pid int) {
...
func (r *MoqGetpid_genType_fnRecorder) ReturnResults(pid int) *MoqGetpid_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
