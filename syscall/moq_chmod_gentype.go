...
type Chmod_genType func(path string, mode uint32) (err error)
...
type MoqChmod_genType_doFn func(path string, mode uint32)

// MoqChmod_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Chmod_genType type
type MoqChmod_genType_doReturnFn func(path string, mode uint32) (err error)
...
func (m *MoqChmod_genType_mock) Fn(path string, mode uint32) (err error) {
...
func (m *MoqChmod_genType) OnCall(path string, mode uint32) *MoqChmod_genType_fnRecorder {
...
func (a *MoqChmod_genType_anyParams) Path() *MoqChmod_genType_fnRecorder {
...
func (r *MoqChmod_genType_fnRecorder) ReturnResults(err error) *MoqChmod_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqChmod_genType) PrettyParams(params MoqChmod_genType_params) string {
	return fmt.Sprintf("Chmod_genType(%#v, %#v)", params.Path, params.Mode)
}
