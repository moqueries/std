...
type Read_genType func(fd int, p []byte) (n int, err error)
...
func (m *MoqRead_genType_mock) Fn(fd int, p []byte) (n int, err error) {
...
func (m *MoqRead_genType) OnCall(fd int, p []byte) *MoqRead_genType_fnRecorder {
...
func (a *MoqRead_genType_anyParams) Fd() *MoqRead_genType_fnRecorder {
...
func (m *MoqRead_genType) PrettyParams(params MoqRead_genType_params) string {
	return fmt.Sprintf("Read_genType(%#v, %#v)", params.Fd, params.P)
}
