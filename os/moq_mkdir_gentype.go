...
type Mkdir_genType func(name string, perm os.FileMode) error
...
type MoqMkdir_genType_doFn func(name string, perm os.FileMode)

// MoqMkdir_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Mkdir_genType type
type MoqMkdir_genType_doReturnFn func(name string, perm os.FileMode) error
...
func (m *MoqMkdir_genType) Mock() Mkdir_genType {
	return func(name string, perm os.FileMode) error {
		...
		return moq.Fn(name, perm)
	}
}

func (m *MoqMkdir_genType_mock) Fn(name string, perm os.FileMode) (result1 error) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(name, perm)
	}
	return
}

func (m *MoqMkdir_genType) OnCall(name string, perm os.FileMode) *MoqMkdir_genType_fnRecorder {
...
func (a *MoqMkdir_genType_anyParams) Name() *MoqMkdir_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqMkdir_genType_anyParams) Perm() *MoqMkdir_genType_fnRecorder {
...
func (r *MoqMkdir_genType_fnRecorder) ReturnResults(result1 error) *MoqMkdir_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqMkdir_genType) PrettyParams(params MoqMkdir_genType_params) string {
	return fmt.Sprintf("Mkdir_genType(%#v, %#v)", params.Name, params.Perm)
}
