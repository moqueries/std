...
type Readlink_genType func(name string) (string, error)
...
type MoqReadlink_genType_params struct{ Name string }
...
type MoqReadlink_genType_doFn func(name string)
...
type MoqReadlink_genType_doReturnFn func(name string) (string, error)
...
func (m *MoqReadlink_genType_mock) Fn(name string) (result1 string, result2 error) {
...
func (m *MoqReadlink_genType) OnCall(name string) *MoqReadlink_genType_fnRecorder {
...
func (a *MoqReadlink_genType_anyParams) Name() *MoqReadlink_genType_fnRecorder {
...
func (r *MoqReadlink_genType_fnRecorder) ReturnResults(result1 string, result2 error) *MoqReadlink_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqReadlink_genType) PrettyParams(params MoqReadlink_genType_params) string {
	return fmt.Sprintf("Readlink_genType(%#v)", params.Name)
}
