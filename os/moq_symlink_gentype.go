...
type Symlink_genType func(oldname, newname string) error
...
type MoqSymlink_genType_params struct{ Oldname, Newname string }
...
type MoqSymlink_genType_doFn func(oldname, newname string)
...
type MoqSymlink_genType_doReturnFn func(oldname, newname string) error
...
func (m *MoqSymlink_genType_mock) Fn(oldname, newname string) (result1 error) {
...
func (m *MoqSymlink_genType) OnCall(oldname, newname string) *MoqSymlink_genType_fnRecorder {
...
func (a *MoqSymlink_genType_anyParams) Oldname() *MoqSymlink_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqSymlink_genType_anyParams) Newname() *MoqSymlink_genType_fnRecorder {
...
func (r *MoqSymlink_genType_fnRecorder) ReturnResults(result1 error) *MoqSymlink_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqSymlink_genType) PrettyParams(params MoqSymlink_genType_params) string {
	return fmt.Sprintf("Symlink_genType(%#v, %#v)", params.Oldname, params.Newname)
}
