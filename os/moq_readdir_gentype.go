...
type ReadDir_genType func(name string) ([]os.DirEntry, error)
...
type MoqReadDir_genType_params struct{ Name string }
...
type MoqReadDir_genType_doFn func(name string)
...
type MoqReadDir_genType_doReturnFn func(name string) ([]os.DirEntry, error)
...
func (m *MoqReadDir_genType_mock) Fn(name string) (result1 []os.DirEntry, result2 error) {
...
func (m *MoqReadDir_genType) OnCall(name string) *MoqReadDir_genType_fnRecorder {
...
func (r *MoqReadDir_genType_fnRecorder) ReturnResults(result1 []os.DirEntry, result2 error) *MoqReadDir_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqReadDir_genType) PrettyParams(params MoqReadDir_genType_params) string {
	return fmt.Sprintf("ReadDir_genType(%#v)", params.Name)
}
