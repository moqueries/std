...
type Open_genType func(name string) (*os.File, error)
...
type MoqOpen_genType_doReturnFn func(name string) (*os.File, error)
...
func (m *MoqOpen_genType_mock) Fn(name string) (result1 *os.File, result2 error) {
...
func (r *MoqOpen_genType_fnRecorder) ReturnResults(result1 *os.File, result2 error) *MoqOpen_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
