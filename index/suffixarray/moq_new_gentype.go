...
type New_genType func(data []byte) *suffixarray.Index
...
type MoqNew_genType_params struct{ Data []byte }
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(data []byte) *suffixarray.Index {
		m.Scene.T.Helper()
...
func (m *MoqNew_genType_mock) Fn(data []byte) (result1 *suffixarray.Index) {
...
func (m *MoqNew_genType) OnCall(data []byte) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Data() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 *suffixarray.Index) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v)", params.Data)
}
