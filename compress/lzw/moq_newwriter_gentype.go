...
type NewWriter_genType func(w io.Writer, order lzw.Order, litWidth int) io.WriteCloser
...
type MoqNewWriter_genType_doFn func(w io.Writer, order lzw.Order, litWidth int)
...
type MoqNewWriter_genType_doReturnFn func(w io.Writer, order lzw.Order, litWidth int) io.WriteCloser
...
func (m *MoqNewWriter_genType) Mock() NewWriter_genType {
	return func(w io.Writer, order lzw.Order, litWidth int) io.WriteCloser {
		m.Scene.T.Helper()
		moq := &MoqNewWriter_genType_mock{Moq: m}
		return moq.Fn(w, order, litWidth)
	}
}

func (m *MoqNewWriter_genType_mock) Fn(w io.Writer, order lzw.Order, litWidth int) (result1 io.WriteCloser) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(w, order, litWidth)
	}
	return
}

func (m *MoqNewWriter_genType) OnCall(w io.Writer, order lzw.Order, litWidth int) *MoqNewWriter_genType_fnRecorder {
...
func (a *MoqNewWriter_genType_anyParams) Order() *MoqNewWriter_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqNewWriter_genType_anyParams) LitWidth() *MoqNewWriter_genType_fnRecorder {
...
func (r *MoqNewWriter_genType_fnRecorder) ReturnResults(result1 io.WriteCloser) *MoqNewWriter_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNewWriter_genType) PrettyParams(params MoqNewWriter_genType_params) string {
	return fmt.Sprintf("NewWriter_genType(%#v, %#v, %#v)", params.W, params.Order, params.LitWidth)
}
