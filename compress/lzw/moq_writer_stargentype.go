...
// The following type assertion assures that lzw.Writer_starGenType is mocked
// completely
...
type Writer_starGenType interface {
	...
	Close() error
	Reset(dst io.Writer, order lzw.Order, litWidth int)
}
...
type MoqWriter_starGenType_Write_doReturnFn func(p []byte) (n int, err error)
...
// Writer_starGenType type
type MoqWriter_starGenType_Reset_params struct {
	Dst      io.Writer
	Order    lzw.Order
	LitWidth int
}
...
// calling AndDo for the Writer_starGenType type
type MoqWriter_starGenType_Reset_doFn func(dst io.Writer, order lzw.Order, litWidth int)

// MoqWriter_starGenType_Reset_doReturnFn defines the type of function needed
// when calling DoReturnResults for the Writer_starGenType type
type MoqWriter_starGenType_Reset_doReturnFn func(dst io.Writer, order lzw.Order, litWidth int)
...
func (m *MoqWriter_starGenType_mock) Write(p []byte) (n int, err error) {
...
func (m *MoqWriter_starGenType_mock) Reset(dst io.Writer, order lzw.Order, litWidth int) {
	m.Moq.Scene.T.Helper()
	params := MoqWriter_starGenType_Reset_params{
		Dst:      dst,
		Order:    order,
	...
	if result.DoFn != nil {
		result.DoFn(dst, order, litWidth)
	}

	if result.DoReturnFn != nil {
		result.DoReturnFn(dst, order, litWidth)
	}
	return
}
...
func (m *MoqWriter_starGenType_recorder) Reset(dst io.Writer, order lzw.Order, litWidth int) *MoqWriter_starGenType_Reset_fnRecorder {
...
func (a *MoqWriter_starGenType_Reset_anyParams) Dst() *MoqWriter_starGenType_Reset_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqWriter_starGenType_Reset_anyParams) Order() *MoqWriter_starGenType_Reset_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqWriter_starGenType_Reset_anyParams) LitWidth() *MoqWriter_starGenType_Reset_fnRecorder {
...
func (m *MoqWriter_starGenType) PrettyParams_Reset(params MoqWriter_starGenType_Reset_params) string {
	return fmt.Sprintf("Reset(%#v, %#v, %#v)", params.Dst, params.Order, params.LitWidth)
}
...
func (m *MoqWriter_starGenType) ParamsKey_Reset(params MoqWriter_starGenType_Reset_params, anyParams uint64) MoqWriter_starGenType_Reset_paramsKey {
	...
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.Reset.Dst == moq.ParamIndexByValue {
			dstUsed = params.Dst
		} else {
