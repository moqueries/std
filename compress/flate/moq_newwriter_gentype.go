...
type NewWriter_genType func(w io.Writer, level int) (*flate.Writer, error)
...
type MoqNewWriter_genType_doFn func(w io.Writer, level int)
...
type MoqNewWriter_genType_doReturnFn func(w io.Writer, level int) (*flate.Writer, error)
...
func (m *MoqNewWriter_genType) Mock() NewWriter_genType {
	return func(w io.Writer, level int) (*flate.Writer, error) {
		m.Scene.T.Helper()
...
func (m *MoqNewWriter_genType_mock) Fn(w io.Writer, level int) (result1 *flate.Writer, result2 error) {
...
func (m *MoqNewWriter_genType) OnCall(w io.Writer, level int) *MoqNewWriter_genType_fnRecorder {
...
func (a *MoqNewWriter_genType_anyParams) Level() *MoqNewWriter_genType_fnRecorder {
...
func (r *MoqNewWriter_genType_fnRecorder) ReturnResults(result1 *flate.Writer, result2 error) *MoqNewWriter_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNewWriter_genType) PrettyParams(params MoqNewWriter_genType_params) string {
	return fmt.Sprintf("NewWriter_genType(%#v, %#v)", params.W, params.Level)
}
