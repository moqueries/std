...
// The following type assertion assures that flate.Reader is mocked completely
var _ flate.Reader = (*MoqReader_mock)(nil)
...
func (m *MoqReader) Reset() { m.ResultsByParams_Read = nil; m.ResultsByParams_ReadByte = nil }
