...
// The following type assertion assures that flate.Writer_starGenType is mocked
// completely
...
// Writer_starGenType type
type MoqWriter_starGenType_Write_params struct{ Data []byte }
...
type MoqWriter_starGenType_Write_doFn func(data []byte)
...
type MoqWriter_starGenType_Write_doReturnFn func(data []byte) (n int, err error)
...
// calling AndDo for the Writer_starGenType type
type MoqWriter_starGenType_Reset_doFn func(dst io.Writer)

// MoqWriter_starGenType_Reset_doReturnFn defines the type of function needed
// when calling DoReturnResults for the Writer_starGenType type
type MoqWriter_starGenType_Reset_doReturnFn func(dst io.Writer)
...
func (m *MoqWriter_starGenType_mock) Write(data []byte) (n int, err error) {
...
func (m *MoqWriter_starGenType_mock) Reset(dst io.Writer) {
	m.Moq.Scene.T.Helper()
	params := MoqWriter_starGenType_Reset_params{
		Dst: dst,
	}
...
func (m *MoqWriter_starGenType_recorder) Write(data []byte) *MoqWriter_starGenType_Write_fnRecorder {
...
func (a *MoqWriter_starGenType_Write_anyParams) Data() *MoqWriter_starGenType_Write_fnRecorder {
...
func (m *MoqWriter_starGenType_recorder) Reset(dst io.Writer) *MoqWriter_starGenType_Reset_fnRecorder {
...
func (m *MoqWriter_starGenType) PrettyParams_Reset(params MoqWriter_starGenType_Reset_params) string {
	return fmt.Sprintf("Reset(%#v)", params.Dst)
}
