...
type NewReaderDict_genType func(r io.Reader, dict []byte) (io.ReadCloser, error)
...
type MoqNewReaderDict_genType_doReturnFn func(r io.Reader, dict []byte) (io.ReadCloser, error)
...
func (m *MoqNewReaderDict_genType) Mock() NewReaderDict_genType {
	return func(param1 io.Reader, dict []byte) (io.ReadCloser, error) {
		m.Scene.T.Helper()
...
func (m *MoqNewReaderDict_genType_mock) Fn(param1 io.Reader, dict []byte) (result1 io.ReadCloser, result2 error) {
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(param1, dict)
	}
	return
}
...
func (r *MoqNewReaderDict_genType_fnRecorder) ReturnResults(result1 io.ReadCloser, result2 error) *MoqNewReaderDict_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
