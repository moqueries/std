...
type NewWriterLevel_genType func(w io.Writer, level int) (*gzip.Writer, error)
...
type MoqNewWriterLevel_genType_doReturnFn func(w io.Writer, level int) (*gzip.Writer, error)
...
func (m *MoqNewWriterLevel_genType) Mock() NewWriterLevel_genType {
	return func(w io.Writer, level int) (*gzip.Writer, error) {
		m.Scene.T.Helper()
...
func (m *MoqNewWriterLevel_genType_mock) Fn(w io.Writer, level int) (result1 *gzip.Writer, result2 error) {
...
func (r *MoqNewWriterLevel_genType_fnRecorder) ReturnResults(result1 *gzip.Writer, result2 error) *MoqNewWriterLevel_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
