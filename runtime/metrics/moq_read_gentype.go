...
type Read_genType func(m []metrics.Sample)
...
type MoqRead_genType_params struct{ Param1 []metrics.Sample }
...
func (m *MoqRead_genType) Mock() Read_genType {
	return func(param1 []metrics.Sample) {
		m.Scene.T.Helper()
...
func (m *MoqRead_genType_mock) Fn(param1 []metrics.Sample) {
...
func (m *MoqRead_genType) OnCall(param1 []metrics.Sample) *MoqRead_genType_fnRecorder {
...
func (r *MoqRead_genType_fnRecorder) ReturnResults() *MoqRead_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
