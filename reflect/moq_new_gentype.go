...
type New_genType func(typ reflect.Type) reflect.Value
...
type MoqNew_genType_params struct{ Typ reflect.Type }
...
func (m *MoqNew_genType_mock) Fn(typ reflect.Type) (result1 reflect.Value) {
...
func (m *MoqNew_genType) OnCall(typ reflect.Type) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Typ() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 reflect.Value) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v)", params.Typ)
}
