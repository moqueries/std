...
type Copy_genType func(dst, src reflect.Value) int
...
func (m *MoqCopy_genType) Mock() Copy_genType {
	return func(dst, src reflect.Value) int {
		m.Scene.T.Helper()
...
func (m *MoqCopy_genType_mock) Fn(dst, src reflect.Value) (result1 int) {
...
func (m *MoqCopy_genType) OnCall(dst, src reflect.Value) *MoqCopy_genType_fnRecorder {
...
func (r *MoqCopy_genType_fnRecorder) ReturnResults(result1 int) *MoqCopy_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
