...
type Dial_genType func(network, address string) (net.Conn, error)
...
type MoqDial_genType_doReturnFn func(network, address string) (net.Conn, error)
...
func (m *MoqDial_genType_mock) Fn(network, address string) (result1 net.Conn, result2 error) {
...
func (r *MoqDial_genType_fnRecorder) ReturnResults(result1 net.Conn, result2 error) *MoqDial_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
