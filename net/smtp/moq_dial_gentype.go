...
type Dial_genType func(addr string) (*smtp.Client, error)
...
type MoqDial_genType_params struct{ Addr string }
...
func (m *MoqDial_genType_mock) Fn(addr string) (result1 *smtp.Client, result2 error) {
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(addr)
	}
	return
}

func (m *MoqDial_genType) OnCall(addr string) *MoqDial_genType_fnRecorder {
...
func (r *MoqDial_genType_fnRecorder) ReturnResults(result1 *smtp.Client, result2 error) *MoqDial_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqDial_genType) PrettyParams(params MoqDial_genType_params) string {
	return fmt.Sprintf("Dial_genType(%#v)", params.Addr)
}
