...
type NewRequest_genType func(method, target string, body io.Reader) *http.Request
...
type MoqNewRequest_genType_doFn func(method, target string, body io.Reader)
...
type MoqNewRequest_genType_doReturnFn func(method, target string, body io.Reader) *http.Request
...
func (m *MoqNewRequest_genType) Mock() NewRequest_genType {
	return func(method, target string, body io.Reader) *http.Request {
		...
		return moq.Fn(method, target, body)
	}
}

func (m *MoqNewRequest_genType_mock) Fn(method, target string, body io.Reader) (result1 *http.Request) {
	...
	if result.DoFn != nil {
		result.DoFn(method, target, body)
	}
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(method, target, body)
	}
	return
}

func (m *MoqNewRequest_genType) OnCall(method, target string, body io.Reader) *MoqNewRequest_genType_fnRecorder {
...
func (a *MoqNewRequest_genType_anyParams) Target() *MoqNewRequest_genType_fnRecorder {
...
func (r *MoqNewRequest_genType_fnRecorder) ReturnResults(result1 *http.Request) *MoqNewRequest_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNewRequest_genType) PrettyParams(params MoqNewRequest_genType_params) string {
	return fmt.Sprintf("NewRequest_genType(%#v, %#v, %#v)", params.Method, params.Target, params.Body)
}
