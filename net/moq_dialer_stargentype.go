...
// The following type assertion assures that net.Dialer_starGenType is mocked
// completely
...
// type
type MoqDialer_starGenType_Dial_params struct{ Network, Address string }
...
type MoqDialer_starGenType_Dial_doFn func(network, address string)
...
type MoqDialer_starGenType_Dial_doReturnFn func(network, address string) (net.Conn, error)
...
type MoqDialer_starGenType_DialContext_doFn func(ctx context.Context, network, address string)
...
type MoqDialer_starGenType_DialContext_doReturnFn func(ctx context.Context, network, address string) (net.Conn, error)
...
func (m *MoqDialer_starGenType_mock) Dial(network, address string) (result1 net.Conn, result2 error) {
...
func (m *MoqDialer_starGenType_mock) DialContext(ctx context.Context, network, address string) (result1 net.Conn, result2 error) {
	m.Moq.Scene.T.Helper()
	params := MoqDialer_starGenType_DialContext_params{
		Ctx:     ctx,
		Network: network,
...
func (m *MoqDialer_starGenType_recorder) Dial(network, address string) *MoqDialer_starGenType_Dial_fnRecorder {
...
func (a *MoqDialer_starGenType_Dial_anyParams) Address() *MoqDialer_starGenType_Dial_fnRecorder {
...
func (m *MoqDialer_starGenType) PrettyParams_Dial(params MoqDialer_starGenType_Dial_params) string {
	return fmt.Sprintf("Dial(%#v, %#v)", params.Network, params.Address)
}
...
func (m *MoqDialer_starGenType) ParamsKey_Dial(params MoqDialer_starGenType_Dial_params, anyParams uint64) MoqDialer_starGenType_Dial_paramsKey {
	...
	if anyParams&(1<<1) == 0 {
		if m.Runtime.ParameterIndexing.Dial.Address == moq.ParamIndexByValue {
...
func (m *MoqDialer_starGenType_recorder) DialContext(ctx context.Context, network, address string) *MoqDialer_starGenType_DialContext_fnRecorder {
...
func (a *MoqDialer_starGenType_DialContext_anyParams) Address() *MoqDialer_starGenType_DialContext_fnRecorder {
...
func (m *MoqDialer_starGenType) PrettyParams_DialContext(params MoqDialer_starGenType_DialContext_params) string {
	return fmt.Sprintf("DialContext(%#v, %#v, %#v)", params.Ctx, params.Network, params.Address)
}
...
func (m *MoqDialer_starGenType) ParamsKey_DialContext(params MoqDialer_starGenType_DialContext_params, anyParams uint64) MoqDialer_starGenType_DialContext_paramsKey {
	...
	var addressUsedHash hash.Hash
	if anyParams&(1<<2) == 0 {
		if m.Runtime.ParameterIndexing.DialContext.Address == moq.ParamIndexByValue {
			addressUsed = params.Address
		} else {
			addressUsedHash = hash.DeepHash(params.Address)
		}
