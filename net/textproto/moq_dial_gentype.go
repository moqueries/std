...
type Dial_genType func(network, addr string) (*textproto.Conn, error)
...
type MoqDial_genType_params struct{ Network, Addr string }
...
type MoqDial_genType_doFn func(network, addr string)

// MoqDial_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Dial_genType type
type MoqDial_genType_doReturnFn func(network, addr string) (*textproto.Conn, error)
...
func (m *MoqDial_genType) Mock() Dial_genType {
	return func(network, addr string) (*textproto.Conn, error) {
		m.Scene.T.Helper()
		moq := &MoqDial_genType_mock{Moq: m}
		return moq.Fn(network, addr)
	}
}

func (m *MoqDial_genType_mock) Fn(network, addr string) (result1 *textproto.Conn, result2 error) {
...
func (m *MoqDial_genType) OnCall(network, addr string) *MoqDial_genType_fnRecorder {
...
func (r *MoqDial_genType_fnRecorder) ReturnResults(result1 *textproto.Conn, result2 error) *MoqDial_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqDial_genType) PrettyParams(params MoqDial_genType_params) string {
	return fmt.Sprintf("Dial_genType(%#v, %#v)", params.Network, params.Addr)
}
