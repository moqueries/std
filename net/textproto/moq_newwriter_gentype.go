...
type NewWriter_genType func(w *bufio.Writer) *textproto.Writer
...
type MoqNewWriter_genType_doFn func(w *bufio.Writer)
...
type MoqNewWriter_genType_doReturnFn func(w *bufio.Writer) *textproto.Writer
...
func (m *MoqNewWriter_genType) Mock() NewWriter_genType {
	return func(w *bufio.Writer) *textproto.Writer {
		m.Scene.T.Helper()
...
func (m *MoqNewWriter_genType_mock) Fn(w *bufio.Writer) (result1 *textproto.Writer) {
...
func (m *MoqNewWriter_genType) OnCall(w *bufio.Writer) *MoqNewWriter_genType_fnRecorder {
...
func (r *MoqNewWriter_genType_fnRecorder) ReturnResults(result1 *textproto.Writer) *MoqNewWriter_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
