...
type New_genType func(n int) *ring.Ring
...
type MoqNew_genType_params struct{ N int }
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(n int) *ring.Ring { m.Scene.T.Helper(); moq := &MoqNew_genType_mock{Moq: m}; return moq.Fn(n) }
}

func (m *MoqNew_genType_mock) Fn(n int) (result1 *ring.Ring) {
...
func (m *MoqNew_genType) OnCall(n int) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) N() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 *ring.Ring) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v)", params.N)
}
