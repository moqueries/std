...
type New_genType func() *list.List
...
type MoqNew_genType_doReturnFn func() *list.List
...
func (m *MoqNew_genType) Mock() New_genType {
	return func() *list.List { m.Scene.T.Helper(); moq := &MoqNew_genType_mock{Moq: m}; return moq.Fn() }
}

func (m *MoqNew_genType_mock) Fn() (result1 *list.List) {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 *list.List) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
