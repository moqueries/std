...
type New_genType func() hash.Hash
...
type MoqNew_genType_doReturnFn func() hash.Hash
...
func (m *MoqNew_genType) Mock() New_genType {
	return func() hash.Hash { m.Scene.T.Helper(); moq := &MoqNew_genType_mock{Moq: m}; return moq.Fn() }
}

func (m *MoqNew_genType_mock) Fn() (result1 hash.Hash) {
