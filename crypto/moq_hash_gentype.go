...
type MoqHash_genType struct {
	...
	ResultsByParams_String    []MoqHash_genType_String_resultsByParams
...
// MoqHash_genType_String_params holds the params of the Hash_genType type
type MoqHash_genType_String_params struct{}

// MoqHash_genType_String_paramsKey holds the map key params of the
// Hash_genType type
type MoqHash_genType_String_paramsKey struct {
	Params struct{}
	Hashes struct{}
}

// MoqHash_genType_String_resultsByParams contains the results for a given set
// of parameters for the Hash_genType type
type MoqHash_genType_String_resultsByParams struct {
	AnyCount  int
	AnyParams uint64
	Results   map[MoqHash_genType_String_paramsKey]*MoqHash_genType_String_results
}

// MoqHash_genType_String_doFn defines the type of function needed when calling
// AndDo for the Hash_genType type
type MoqHash_genType_String_doFn func()

// MoqHash_genType_String_doReturnFn defines the type of function needed when
// calling DoReturnResults for the Hash_genType type
type MoqHash_genType_String_doReturnFn func() string

// MoqHash_genType_String_results holds the results of the Hash_genType type
type MoqHash_genType_String_results struct {
	Params  MoqHash_genType_String_params
	Results []struct {
		Values *struct {
			Result1 string
		}
		Sequence   uint32
		DoFn       MoqHash_genType_String_doFn
		DoReturnFn MoqHash_genType_String_doReturnFn
	}
	Index  uint32
	Repeat *moq.RepeatVal
}

// MoqHash_genType_String_fnRecorder routes recorded function calls to the
// MoqHash_genType moq
type MoqHash_genType_String_fnRecorder struct {
	Params    MoqHash_genType_String_params
	AnyParams uint64
	Sequence  bool
	Results   *MoqHash_genType_String_results
	Moq       *MoqHash_genType
}

// MoqHash_genType_String_anyParams isolates the any params functions of the
// Hash_genType type
type MoqHash_genType_String_anyParams struct {
	Recorder *MoqHash_genType_String_fnRecorder
}
...
func (m *MoqHash_genType_mock) String() (result1 string) {
	m.Moq.Scene.T.Helper()
	params := MoqHash_genType_String_params{}
	var results *MoqHash_genType_String_results
...
func (m *MoqHash_genType_recorder) String() *MoqHash_genType_String_fnRecorder {
	return &MoqHash_genType_String_fnRecorder{
		Params:   MoqHash_genType_String_params{},
		Sequence: m.Moq.Config.Sequence == moq.SeqDefaultOn,
		Moq:      m.Moq,
	}
...
func (r *MoqHash_genType_String_fnRecorder) Any() *MoqHash_genType_String_anyParams {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Moq.Scene.T.Fatalf("Any functions must be called before ReturnResults or DoReturnResults calls, recording %s", r.Moq.PrettyParams_String(r.Params))
		return nil
	}
	return &MoqHash_genType_String_anyParams{Recorder: r}
}

func (r *MoqHash_genType_String_fnRecorder) Seq() *MoqHash_genType_String_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqHash_genType_String_fnRecorder) NoSeq() *MoqHash_genType_String_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqHash_genType_String_fnRecorder) ReturnResults(result1 string) *MoqHash_genType_String_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqHash_genType_String_fnRecorder) AndDo(fn MoqHash_genType_String_doFn) *MoqHash_genType_String_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults must be called before calling AndDo")
		return nil
...
func (r *MoqHash_genType_String_fnRecorder) DoReturnResults(fn MoqHash_genType_String_doReturnFn) *MoqHash_genType_String_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqHash_genType_String_fnRecorder) FindResults() {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Results.Repeat.Increment(r.Moq.Scene.T)
		return
	...
	anyCount := bits.OnesCount64(r.AnyParams)
	insertAt := -1
	var results *MoqHash_genType_String_resultsByParams
	...
	if results == nil {
		results = &MoqHash_genType_String_resultsByParams{
			AnyCount:  anyCount,
			AnyParams: r.AnyParams,
			Results:   map[MoqHash_genType_String_paramsKey]*MoqHash_genType_String_results{},
		}
	...
	r.Results, ok = results.Results[paramsKey]
	if !ok {
		r.Results = &MoqHash_genType_String_results{
			Params:  r.Params,
			Results: nil,
			Index:   0,
			Repeat:  &moq.RepeatVal{},
...
func (r *MoqHash_genType_String_fnRecorder) Repeat(repeaters ...moq.Repeater) *MoqHash_genType_String_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults or DoReturnResults must be called before calling Repeat")
		return nil
...
func (m *MoqHash_genType) PrettyParams_String(params MoqHash_genType_String_params) string {
	return fmt.Sprintf("String()")
}

func (m *MoqHash_genType) ParamsKey_String(params MoqHash_genType_String_params, anyParams uint64) MoqHash_genType_String_paramsKey {
	m.Scene.T.Helper()
	return MoqHash_genType_String_paramsKey{
		Params: struct{}{},
		Hashes: struct{}{},
	}
}
