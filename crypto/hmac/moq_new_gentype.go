...
type New_genType func(h func() hash.Hash, key []byte) hash.Hash
...
type MoqNew_genType_doFn func(h func() hash.Hash, key []byte)

// MoqNew_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the New_genType type
type MoqNew_genType_doReturnFn func(h func() hash.Hash, key []byte) hash.Hash
...
func (m *MoqNew_genType_mock) Fn(h func() hash.Hash, key []byte) (result1 hash.Hash) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(h, key)
	}
	return
}

func (m *MoqNew_genType) OnCall(h func() hash.Hash, key []byte) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) H() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Key() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 hash.Hash) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v, %#v)", moq.FnString(params.H), params.Key)
}
