...
type Marshal_genType func(curve elliptic.Curve, x, y *big.Int) []byte
...
type MoqMarshal_genType_params struct {
...
type MoqMarshal_genType_doFn func(curve elliptic.Curve, x, y *big.Int)
...
type MoqMarshal_genType_doReturnFn func(curve elliptic.Curve, x, y *big.Int) []byte
...
func (m *MoqMarshal_genType_mock) Fn(curve elliptic.Curve, x, y *big.Int) (result1 []byte) {
...
func (m *MoqMarshal_genType) OnCall(curve elliptic.Curve, x, y *big.Int) *MoqMarshal_genType_fnRecorder {
...
func (a *MoqMarshal_genType_anyParams) Curve() *MoqMarshal_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqMarshal_genType_anyParams) X() *MoqMarshal_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqMarshal_genType_anyParams) Y() *MoqMarshal_genType_fnRecorder {
...
func (r *MoqMarshal_genType_fnRecorder) ReturnResults(result1 []byte) *MoqMarshal_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqMarshal_genType) PrettyParams(params MoqMarshal_genType_params) string {
	return fmt.Sprintf("Marshal_genType(%#v, %#v, %#v)", params.Curve, params.X, params.Y)
}
