...
type Unmarshal_genType func(curve elliptic.Curve, data []byte) (x, y *big.Int)
...
type MoqUnmarshal_genType_doFn func(curve elliptic.Curve, data []byte)
...
type MoqUnmarshal_genType_doReturnFn func(curve elliptic.Curve, data []byte) (x, y *big.Int)
...
func (m *MoqUnmarshal_genType_mock) Fn(curve elliptic.Curve, data []byte) (x, y *big.Int) {
...
func (m *MoqUnmarshal_genType) OnCall(curve elliptic.Curve, data []byte) *MoqUnmarshal_genType_fnRecorder {
...
func (a *MoqUnmarshal_genType_anyParams) Curve() *MoqUnmarshal_genType_fnRecorder {
...
func (r *MoqUnmarshal_genType_fnRecorder) ReturnResults(x, y *big.Int) *MoqUnmarshal_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqUnmarshal_genType) PrettyParams(params MoqUnmarshal_genType_params) string {
	return fmt.Sprintf("Unmarshal_genType(%#v, %#v)", params.Curve, params.Data)
}
