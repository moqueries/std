...
type Dial_genType func(network, addr string, config *tls.Config) (*tls.Conn, error)
...
type MoqDial_genType_doFn func(network, addr string, config *tls.Config)

// MoqDial_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Dial_genType type
type MoqDial_genType_doReturnFn func(network, addr string, config *tls.Config) (*tls.Conn, error)
...
func (m *MoqDial_genType) Mock() Dial_genType {
	return func(network, addr string, config *tls.Config) (*tls.Conn, error) {
		...
		return moq.Fn(network, addr, config)
	}
}

func (m *MoqDial_genType_mock) Fn(network, addr string, config *tls.Config) (result1 *tls.Conn, result2 error) {
	...
	if result.DoFn != nil {
		result.DoFn(network, addr, config)
	}
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(network, addr, config)
	}
	return
}

func (m *MoqDial_genType) OnCall(network, addr string, config *tls.Config) *MoqDial_genType_fnRecorder {
...
func (a *MoqDial_genType_anyParams) Addr() *MoqDial_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqDial_genType_anyParams) Config() *MoqDial_genType_fnRecorder {
...
func (r *MoqDial_genType_fnRecorder) ReturnResults(result1 *tls.Conn, result2 error) *MoqDial_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqDial_genType) PrettyParams(params MoqDial_genType_params) string {
	return fmt.Sprintf("Dial_genType(%#v, %#v, %#v)", params.Network, params.Addr, params.Config)
}
