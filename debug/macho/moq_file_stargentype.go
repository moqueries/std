...
// The following type assertion assures that macho.File_starGenType is mocked
// completely
...
type File_starGenType interface {
	...
	Section(name string) *macho.Section
...
type MoqFile_starGenType struct {
	...
	ResultsByParams_Segment           []MoqFile_starGenType_Segment_resultsByParams
...
// MoqFile_starGenType_Segment_params holds the params of the File_starGenType
// type
type MoqFile_starGenType_Segment_params struct{ Name string }

// MoqFile_starGenType_Segment_paramsKey holds the map key params of the
// File_starGenType type
type MoqFile_starGenType_Segment_paramsKey struct {
	Params struct{ Name string }
	Hashes struct{ Name hash.Hash }
}

// MoqFile_starGenType_Segment_resultsByParams contains the results for a given
// set of parameters for the File_starGenType type
type MoqFile_starGenType_Segment_resultsByParams struct {
	AnyCount  int
	AnyParams uint64
	Results   map[MoqFile_starGenType_Segment_paramsKey]*MoqFile_starGenType_Segment_results
}

// MoqFile_starGenType_Segment_doFn defines the type of function needed when
// calling AndDo for the File_starGenType type
type MoqFile_starGenType_Segment_doFn func(name string)

// MoqFile_starGenType_Segment_doReturnFn defines the type of function needed
// when calling DoReturnResults for the File_starGenType type
type MoqFile_starGenType_Segment_doReturnFn func(name string) *macho.Segment

// MoqFile_starGenType_Segment_results holds the results of the
// File_starGenType type
type MoqFile_starGenType_Segment_results struct {
	Params  MoqFile_starGenType_Segment_params
	Results []struct {
		Values *struct {
			Result1 *macho.Segment
		}
		Sequence   uint32
		DoFn       MoqFile_starGenType_Segment_doFn
		DoReturnFn MoqFile_starGenType_Segment_doReturnFn
	}
	Index  uint32
	Repeat *moq.RepeatVal
}

// MoqFile_starGenType_Segment_fnRecorder routes recorded function calls to the
// MoqFile_starGenType moq
type MoqFile_starGenType_Segment_fnRecorder struct {
	Params    MoqFile_starGenType_Segment_params
	AnyParams uint64
	Sequence  bool
	Results   *MoqFile_starGenType_Segment_results
	Moq       *MoqFile_starGenType
}

// MoqFile_starGenType_Segment_anyParams isolates the any params functions of
// the File_starGenType type
type MoqFile_starGenType_Segment_anyParams struct {
	Recorder *MoqFile_starGenType_Segment_fnRecorder
}
...
// when calling DoReturnResults for the File_starGenType type
type MoqFile_starGenType_Section_doReturnFn func(name string) *macho.Section
...
func (m *MoqFile_starGenType_mock) Segment(name string) (result1 *macho.Segment) {
	m.Moq.Scene.T.Helper()
	params := MoqFile_starGenType_Segment_params{
		Name: name,
	}
	var results *MoqFile_starGenType_Segment_results
	for _, resultsByParams := range m.Moq.ResultsByParams_Segment {
		paramsKey := m.Moq.ParamsKey_Segment(params, resultsByParams.AnyParams)
		var ok bool
		results, ok = resultsByParams.Results[paramsKey]
		if ok {
			break
	...
	if results == nil {
		if m.Moq.Config.Expectation == moq.Strict {
			m.Moq.Scene.T.Fatalf("Unexpected call to %s", m.Moq.PrettyParams_Segment(params))
		}
		return
	}
	...
	if i >= results.Repeat.ResultCount {
		if !results.Repeat.AnyTimes {
			if m.Moq.Config.Expectation == moq.Strict {
				m.Moq.Scene.T.Fatalf("Too many calls to %s", m.Moq.PrettyParams_Segment(params))
			}
			return
		}
		i = results.Repeat.ResultCount - 1
	...
	if result.Sequence != 0 {
		sequence := m.Moq.Scene.NextMockSequence()
		if (!results.Repeat.AnyTimes && result.Sequence != sequence) || result.Sequence > sequence {
			m.Moq.Scene.T.Fatalf("Call sequence does not match call to %s", m.Moq.PrettyParams_Segment(params))
		}
	}
...
func (m *MoqFile_starGenType_mock) Section(name string) (result1 *macho.Section) {
	m.Moq.Scene.T.Helper()
	params := MoqFile_starGenType_Section_params{
		Name: name,
	}
...
func (m *MoqFile_starGenType_recorder) Segment(name string) *MoqFile_starGenType_Segment_fnRecorder {
	return &MoqFile_starGenType_Segment_fnRecorder{
		Params: MoqFile_starGenType_Segment_params{
			Name: name,
		},
		Sequence: m.Moq.Config.Sequence == moq.SeqDefaultOn,
...
func (r *MoqFile_starGenType_Segment_fnRecorder) Any() *MoqFile_starGenType_Segment_anyParams {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Moq.Scene.T.Fatalf("Any functions must be called before ReturnResults or DoReturnResults calls, recording %s", r.Moq.PrettyParams_Segment(r.Params))
		return nil
	}
	return &MoqFile_starGenType_Segment_anyParams{Recorder: r}
}

func (a *MoqFile_starGenType_Segment_anyParams) Name() *MoqFile_starGenType_Segment_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (r *MoqFile_starGenType_Segment_fnRecorder) Seq() *MoqFile_starGenType_Segment_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Moq.Scene.T.Fatalf("Seq must be called before ReturnResults or DoReturnResults calls, recording %s", r.Moq.PrettyParams_Segment(r.Params))
		return nil
	}
	r.Sequence = true
	return r
...
func (r *MoqFile_starGenType_Segment_fnRecorder) NoSeq() *MoqFile_starGenType_Segment_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Moq.Scene.T.Fatalf("NoSeq must be called before ReturnResults or DoReturnResults calls, recording %s", r.Moq.PrettyParams_Segment(r.Params))
		return nil
	}
	r.Sequence = false
	return r
...
func (r *MoqFile_starGenType_Segment_fnRecorder) ReturnResults(result1 *macho.Segment) *MoqFile_starGenType_Segment_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqFile_starGenType_Segment_fnRecorder) AndDo(fn MoqFile_starGenType_Segment_doFn) *MoqFile_starGenType_Segment_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults must be called before calling AndDo")
		return nil
...
func (r *MoqFile_starGenType_Segment_fnRecorder) DoReturnResults(fn MoqFile_starGenType_Segment_doReturnFn) *MoqFile_starGenType_Segment_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqFile_starGenType_Segment_fnRecorder) FindResults() {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Results.Repeat.Increment(r.Moq.Scene.T)
		return
	...
	anyCount := bits.OnesCount64(r.AnyParams)
	insertAt := -1
	var results *MoqFile_starGenType_Segment_resultsByParams
	for n, res := range r.Moq.ResultsByParams_Segment {
		if res.AnyParams == r.AnyParams {
			results = &res
			break
		}
	...
	if results == nil {
		results = &MoqFile_starGenType_Segment_resultsByParams{
			AnyCount:  anyCount,
			AnyParams: r.AnyParams,
			Results:   map[MoqFile_starGenType_Segment_paramsKey]*MoqFile_starGenType_Segment_results{},
		}
		r.Moq.ResultsByParams_Segment = append(r.Moq.ResultsByParams_Segment, *results)
		if insertAt != -1 && insertAt+1 < len(r.Moq.ResultsByParams_Segment) {
			copy(r.Moq.ResultsByParams_Segment[insertAt+1:], r.Moq.ResultsByParams_Segment[insertAt:0])
			r.Moq.ResultsByParams_Segment[insertAt] = *results
		}
	}

	paramsKey := r.Moq.ParamsKey_Segment(r.Params, r.AnyParams)

	var ok bool
	r.Results, ok = results.Results[paramsKey]
	if !ok {
		r.Results = &MoqFile_starGenType_Segment_results{
			Params:  r.Params,
			Results: nil,
			Index:   0,
			Repeat:  &moq.RepeatVal{},
...
func (r *MoqFile_starGenType_Segment_fnRecorder) Repeat(repeaters ...moq.Repeater) *MoqFile_starGenType_Segment_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults or DoReturnResults must be called before calling Repeat")
		return nil
...
func (m *MoqFile_starGenType) PrettyParams_Segment(params MoqFile_starGenType_Segment_params) string {
	return fmt.Sprintf("Segment(%#v)", params.Name)
}

func (m *MoqFile_starGenType) ParamsKey_Segment(params MoqFile_starGenType_Segment_params, anyParams uint64) MoqFile_starGenType_Segment_paramsKey {
	m.Scene.T.Helper()
	var nameUsed string
	var nameUsedHash hash.Hash
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.Segment.Name == moq.ParamIndexByValue {
			nameUsed = params.Name
		} else {
			nameUsedHash = hash.DeepHash(params.Name)
		}
	}
	return MoqFile_starGenType_Segment_paramsKey{
		Params: struct{ Name string }{
			Name: nameUsed,
		},
		Hashes: struct{ Name hash.Hash }{
...
func (r *MoqFile_starGenType_Section_fnRecorder) ReturnResults(result1 *macho.Section) *MoqFile_starGenType_Section_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqFile_starGenType) AssertExpectationsMet() {
	...
	for _, res := range m.ResultsByParams_Segment {
		for _, results := range res.Results {
			missing := results.Repeat.MinTimes - int(atomic.LoadUint32(&results.Index))
			if missing > 0 {
				m.Scene.T.Errorf("Expected %d additional call(s) to %s", missing, m.PrettyParams_Segment(results.Params))
			}
		}
	}
