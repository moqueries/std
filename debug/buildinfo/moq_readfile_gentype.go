...
type ReadFile_genType func(name string) (info *buildinfo.BuildInfo, err error)
...
type MoqReadFile_genType_doReturnFn func(name string) (info *buildinfo.BuildInfo, err error)
...
func (m *MoqReadFile_genType) Mock() ReadFile_genType {
	return func(name string) (_ *buildinfo.BuildInfo, _ error) {
		m.Scene.T.Helper()
...
func (m *MoqReadFile_genType_mock) Fn(name string) (info *buildinfo.BuildInfo, err error) {
	...
	if result.DoReturnFn != nil {
		info, err = result.DoReturnFn(name)
	}
	return
}
...
func (r *MoqReadFile_genType_fnRecorder) ReturnResults(info *buildinfo.BuildInfo, err error) *MoqReadFile_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
