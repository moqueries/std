...
type Open_genType func(name string) (*plan9obj.File, error)
...
type MoqOpen_genType_doReturnFn func(name string) (*plan9obj.File, error)
...
func (m *MoqOpen_genType) Mock() Open_genType {
	return func(name string) (*plan9obj.File, error) {
		m.Scene.T.Helper()
...
func (m *MoqOpen_genType_mock) Fn(name string) (result1 *plan9obj.File, result2 error) {
...
func (r *MoqOpen_genType_fnRecorder) ReturnResults(result1 *plan9obj.File, result2 error) *MoqOpen_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
