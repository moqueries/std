...
type New_genType func(abbrev, aranges, frame, info, line, pubnames, ranges, str []byte) (*dwarf.Data, error)
...
type MoqNew_genType struct {
	...
	Runtime struct {
		ParameterIndexing struct {
			Abbrev   moq.ParamIndexing
			Aranges  moq.ParamIndexing
			Frame    moq.ParamIndexing
			Info     moq.ParamIndexing
			Line     moq.ParamIndexing
			Pubnames moq.ParamIndexing
...
type MoqNew_genType_params struct{ Abbrev, Aranges, Frame, Info, Line, Pubnames, Ranges, Str []byte }

// MoqNew_genType_paramsKey holds the map key params of the New_genType type
type MoqNew_genType_paramsKey struct {
	Params struct{}
	Hashes struct{ Abbrev, Aranges, Frame, Info, Line, Pubnames, Ranges, Str hash.Hash }
}
...
type MoqNew_genType_doFn func(abbrev, aranges, frame, info, line, pubnames, ranges, str []byte)

// MoqNew_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the New_genType type
type MoqNew_genType_doReturnFn func(abbrev, aranges, frame, info, line, pubnames, ranges, str []byte) (*dwarf.Data, error)
...
func NewMoqNew_genType(scene *moq.Scene, config *moq.Config) *MoqNew_genType {
	...
	m := &MoqNew_genType{
		...
		Runtime: struct {
			...
			Abbrev:   moq.ParamIndexByHash,
			Aranges:  moq.ParamIndexByHash,
			Frame:    moq.ParamIndexByHash,
			Info:     moq.ParamIndexByHash,
			Line:     moq.ParamIndexByHash,
			Pubnames: moq.ParamIndexByHash,
			Ranges:   moq.ParamIndexByHash,
			Str:      moq.ParamIndexByHash,
		}},
	}
	m.Moq.Moq = m
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(abbrev, aranges, frame, info, line, pubnames, ranges, str []byte) (*dwarf.Data, error) {
		m.Scene.T.Helper()
		moq := &MoqNew_genType_mock{Moq: m}
		return moq.Fn(abbrev, aranges, frame, info, line, pubnames, ranges, str)
	}
}

func (m *MoqNew_genType_mock) Fn(abbrev, aranges, frame, info, line, pubnames, ranges, str []byte) (result1 *dwarf.Data, result2 error) {
	...
	if result.DoFn != nil {
		result.DoFn(abbrev, aranges, frame, info, line, pubnames, ranges, str)
	}
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(abbrev, aranges, frame, info, line, pubnames, ranges, str)
	}
	return
}

func (m *MoqNew_genType) OnCall(abbrev, aranges, frame, info, line, pubnames, ranges, str []byte) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Abbrev() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Aranges() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Frame() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 2
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Info() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 3
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Line() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 4
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Pubnames() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 5
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Ranges() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 6
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Str() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 *dwarf.Data, result2 error) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v, %#v, %#v, %#v, %#v, %#v, %#v, %#v)", params.Abbrev, params.Aranges, params.Frame, params.Info, params.Line, params.Pubnames, params.Ranges, params.Str)
}

func (m *MoqNew_genType) ParamsKey(params MoqNew_genType_params, anyParams uint64) MoqNew_genType_paramsKey {
	m.Scene.T.Helper()
	var abbrevUsedHash hash.Hash
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.Abbrev == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The abbrev parameter can't be indexed by value")
		}
		abbrevUsedHash = hash.DeepHash(params.Abbrev)
	}
	var arangesUsedHash hash.Hash
	if anyParams&(1<<1) == 0 {
		if m.Runtime.ParameterIndexing.Aranges == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The aranges parameter can't be indexed by value")
		}
		arangesUsedHash = hash.DeepHash(params.Aranges)
	}
	var frameUsedHash hash.Hash
	if anyParams&(1<<2) == 0 {
		if m.Runtime.ParameterIndexing.Frame == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The frame parameter can't be indexed by value")
		}
		frameUsedHash = hash.DeepHash(params.Frame)
	}
	var infoUsedHash hash.Hash
	if anyParams&(1<<3) == 0 {
		if m.Runtime.ParameterIndexing.Info == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The info parameter can't be indexed by value")
		}
	...
	if anyParams&(1<<4) == 0 {
		if m.Runtime.ParameterIndexing.Line == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The line parameter can't be indexed by value")
		}
		lineUsedHash = hash.DeepHash(params.Line)
	}
	var pubnamesUsedHash hash.Hash
	if anyParams&(1<<5) == 0 {
		if m.Runtime.ParameterIndexing.Pubnames == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The pubnames parameter can't be indexed by value")
		}
		pubnamesUsedHash = hash.DeepHash(params.Pubnames)
	}
	...
	if anyParams&(1<<7) == 0 {
		if m.Runtime.ParameterIndexing.Str == moq.ParamIndexByValue {
			m.Scene.T.Fatalf("The str parameter can't be indexed by value")
		}
	...
	return MoqNew_genType_paramsKey{
		Params: struct{}{},
		Hashes: struct{ Abbrev, Aranges, Frame, Info, Line, Pubnames, Ranges, Str hash.Hash }{
			Abbrev:   abbrevUsedHash,
			Aranges:  arangesUsedHash,
			Frame:    frameUsedHash,
			Info:     infoUsedHash,
			Line:     lineUsedHash,
			Pubnames: pubnamesUsedHash,
