...
type Log10_genType func(x float64) float64
...
type MoqLog10_genType_params struct{ X float64 }
...
func (m *MoqLog10_genType) Mock() Log10_genType {
	return func(x float64) float64 { m.Scene.T.Helper(); moq := &MoqLog10_genType_mock{Moq: m}; return moq.Fn(x) }
}

func (m *MoqLog10_genType_mock) Fn(x float64) (result1 float64) {
...
func (m *MoqLog10_genType) OnCall(x float64) *MoqLog10_genType_fnRecorder {
...
func (r *MoqLog10_genType_fnRecorder) ReturnResults(result1 float64) *MoqLog10_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
