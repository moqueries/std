...
type New_genType func(src rand.Source) *rand.Rand
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(src rand.Source) *rand.Rand {
		m.Scene.T.Helper()
...
func (m *MoqNew_genType_mock) Fn(src rand.Source) (result1 *rand.Rand) {
...
func (m *MoqNew_genType) OnCall(src rand.Source) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Src() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 *rand.Rand) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
