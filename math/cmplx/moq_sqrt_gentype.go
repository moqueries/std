...
type Sqrt_genType func(x complex128) complex128
...
type MoqSqrt_genType_params struct{ X complex128 }
...
func (m *MoqSqrt_genType) Mock() Sqrt_genType {
	return func(x complex128) complex128 {
		m.Scene.T.Helper()
		moq := &MoqSqrt_genType_mock{Moq: m}
		return moq.Fn(x)
	}
}

func (m *MoqSqrt_genType_mock) Fn(x complex128) (result1 complex128) {
...
func (m *MoqSqrt_genType) OnCall(x complex128) *MoqSqrt_genType_fnRecorder {
...
func (r *MoqSqrt_genType_fnRecorder) ReturnResults(result1 complex128) *MoqSqrt_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
