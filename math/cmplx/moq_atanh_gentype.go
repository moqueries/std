...
type Atanh_genType func(x complex128) complex128
...
type MoqAtanh_genType_params struct{ X complex128 }
...
func (m *MoqAtanh_genType) Mock() Atanh_genType {
	return func(x complex128) complex128 {
		m.Scene.T.Helper()
		moq := &MoqAtanh_genType_mock{Moq: m}
		return moq.Fn(x)
	}
}

func (m *MoqAtanh_genType_mock) Fn(x complex128) (result1 complex128) {
...
func (m *MoqAtanh_genType) OnCall(x complex128) *MoqAtanh_genType_fnRecorder {
...
func (r *MoqAtanh_genType_fnRecorder) ReturnResults(result1 complex128) *MoqAtanh_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
