...
type Sin_genType func(x float64) float64
...
type MoqSin_genType_params struct{ X float64 }
...
func (m *MoqSin_genType) Mock() Sin_genType {
	return func(x float64) float64 { m.Scene.T.Helper(); moq := &MoqSin_genType_mock{Moq: m}; return moq.Fn(x) }
}

func (m *MoqSin_genType_mock) Fn(x float64) (result1 float64) {
...
func (m *MoqSin_genType) OnCall(x float64) *MoqSin_genType_fnRecorder {
...
func (r *MoqSin_genType_fnRecorder) ReturnResults(result1 float64) *MoqSin_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
