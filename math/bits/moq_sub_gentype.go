...
type Sub_genType func(x, y, borrow uint) (diff, borrowOut uint)
...
type MoqSub_genType_doFn func(x, y, borrow uint)

// MoqSub_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Sub_genType type
type MoqSub_genType_doReturnFn func(x, y, borrow uint) (diff, borrowOut uint)
...
type MoqSub_genType_results struct {
	...
	Results []struct {
		Values     *struct{ Diff, BorrowOut uint }
		Sequence   uint32
...
func (m *MoqSub_genType) Mock() Sub_genType {
	return func(x, y, borrow uint) (_, _ uint) {
		m.Scene.T.Helper()
...
func (m *MoqSub_genType_mock) Fn(x, y, borrow uint) (diff, borrowOut uint) {
...
func (m *MoqSub_genType) OnCall(x, y, borrow uint) *MoqSub_genType_fnRecorder {
...
func (a *MoqSub_genType_anyParams) X() *MoqSub_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqSub_genType_anyParams) Y() *MoqSub_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqSub_genType_anyParams) Borrow() *MoqSub_genType_fnRecorder {
...
func (r *MoqSub_genType_fnRecorder) ReturnResults(diff, borrowOut uint) *MoqSub_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqSub_genType) PrettyParams(params MoqSub_genType_params) string {
	return fmt.Sprintf("Sub_genType(%#v, %#v, %#v)", params.X, params.Y, params.Borrow)
}
