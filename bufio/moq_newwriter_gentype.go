...
type NewWriter_genType func(w io.Writer) *bufio.Writer
...
type MoqNewWriter_genType_doReturnFn func(w io.Writer) *bufio.Writer
...
func (m *MoqNewWriter_genType) Mock() NewWriter_genType {
	return func(w io.Writer) *bufio.Writer {
		m.Scene.T.Helper()
...
func (m *MoqNewWriter_genType_mock) Fn(w io.Writer) (result1 *bufio.Writer) {
...
func (r *MoqNewWriter_genType_fnRecorder) ReturnResults(result1 *bufio.Writer) *MoqNewWriter_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
