...
type Dial_genType func(network, raddr string, priority syslog.Priority, tag string) (*syslog.Writer, error)
...
type MoqDial_genType_params struct {
...
type MoqDial_genType_doFn func(network, raddr string, priority syslog.Priority, tag string)

// MoqDial_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the Dial_genType type
type MoqDial_genType_doReturnFn func(network, raddr string, priority syslog.Priority, tag string) (*syslog.Writer, error)
...
func NewMoqDial_genType(scene *moq.Scene, config *moq.Config) *MoqDial_genType {
	...
	m := &MoqDial_genType{
		...
		Runtime: struct {
			...
			Raddr:    moq.ParamIndexByValue,
			Priority: moq.ParamIndexByValue,
...
func (m *MoqDial_genType) Mock() Dial_genType {
	return func(network, raddr string, priority syslog.Priority, tag string) (*syslog.Writer, error) {
		m.Scene.T.Helper()
		moq := &MoqDial_genType_mock{Moq: m}
		return moq.Fn(network, raddr, priority, tag)
	}
}

func (m *MoqDial_genType_mock) Fn(network, raddr string, priority syslog.Priority, tag string) (result1 *syslog.Writer, result2 error) {
	...
	if result.DoFn != nil {
		result.DoFn(network, raddr, priority, tag)
	}
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(network, raddr, priority, tag)
	}
	return
}

func (m *MoqDial_genType) OnCall(network, raddr string, priority syslog.Priority, tag string) *MoqDial_genType_fnRecorder {
...
func (a *MoqDial_genType_anyParams) Raddr() *MoqDial_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqDial_genType_anyParams) Priority() *MoqDial_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 2
	return a.Recorder
}

func (a *MoqDial_genType_anyParams) Tag() *MoqDial_genType_fnRecorder {
...
func (r *MoqDial_genType_fnRecorder) ReturnResults(result1 *syslog.Writer, result2 error) *MoqDial_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqDial_genType) PrettyParams(params MoqDial_genType_params) string {
	return fmt.Sprintf("Dial_genType(%#v, %#v, %#v, %#v)", params.Network, params.Raddr, params.Priority, params.Tag)
}
...
func (m *MoqDial_genType) ParamsKey(params MoqDial_genType_params, anyParams uint64) MoqDial_genType_paramsKey {
	...
	var priorityUsed syslog.Priority
	var priorityUsedHash hash.Hash
	if anyParams&(1<<2) == 0 {
		if m.Runtime.ParameterIndexing.Priority == moq.ParamIndexByValue {
			priorityUsed = params.Priority
		} else {
			priorityUsedHash = hash.DeepHash(params.Priority)
		}
	}
	var tagUsed string
	var tagUsedHash hash.Hash
	if anyParams&(1<<3) == 0 {
		if m.Runtime.ParameterIndexing.Tag == moq.ParamIndexByValue {
			tagUsed = params.Tag
		} else {
