...
type New_genType func(priority syslog.Priority, tag string) (*syslog.Writer, error)
...
type MoqNew_genType_doFn func(priority syslog.Priority, tag string)

// MoqNew_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the New_genType type
type MoqNew_genType_doReturnFn func(priority syslog.Priority, tag string) (*syslog.Writer, error)
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(priority syslog.Priority, tag string) (*syslog.Writer, error) {
		m.Scene.T.Helper()
		moq := &MoqNew_genType_mock{Moq: m}
		return moq.Fn(priority, tag)
	}
}

func (m *MoqNew_genType_mock) Fn(priority syslog.Priority, tag string) (result1 *syslog.Writer, result2 error) {
	...
	if result.DoReturnFn != nil {
		result1, result2 = result.DoReturnFn(priority, tag)
	}
	return
}

func (m *MoqNew_genType) OnCall(priority syslog.Priority, tag string) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Priority() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Tag() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 *syslog.Writer, result2 error) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v, %#v)", params.Priority, params.Tag)
}
