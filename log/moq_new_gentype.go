...
type New_genType func(out io.Writer, prefix string, flag int) *log.Logger
...
type MoqNew_genType_doFn func(out io.Writer, prefix string, flag int)

// MoqNew_genType_doReturnFn defines the type of function needed when calling
// DoReturnResults for the New_genType type
type MoqNew_genType_doReturnFn func(out io.Writer, prefix string, flag int) *log.Logger
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(out io.Writer, prefix string, flag int) *log.Logger {
		m.Scene.T.Helper()
		moq := &MoqNew_genType_mock{Moq: m}
		return moq.Fn(out, prefix, flag)
	}
}

func (m *MoqNew_genType_mock) Fn(out io.Writer, prefix string, flag int) (result1 *log.Logger) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(out, prefix, flag)
	}
	return
}

func (m *MoqNew_genType) OnCall(out io.Writer, prefix string, flag int) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Out() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Prefix() *MoqNew_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqNew_genType_anyParams) Flag() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 *log.Logger) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
