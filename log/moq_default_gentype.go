...
type Default_genType func() *log.Logger
...
type MoqDefault_genType_doReturnFn func() *log.Logger
...
func (m *MoqDefault_genType) Mock() Default_genType {
	return func() *log.Logger { m.Scene.T.Helper(); moq := &MoqDefault_genType_mock{Moq: m}; return moq.Fn() }
}

func (m *MoqDefault_genType_mock) Fn() (result1 *log.Logger) {
...
func (r *MoqDefault_genType_fnRecorder) ReturnResults(result1 *log.Logger) *MoqDefault_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
