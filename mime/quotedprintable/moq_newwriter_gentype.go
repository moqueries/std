...
type NewWriter_genType func(w io.Writer) *quotedprintable.Writer
...
type MoqNewWriter_genType_doReturnFn func(w io.Writer) *quotedprintable.Writer
...
type MoqNewWriter_genType_results struct {
	...
	Results []struct {
		Values *struct {
			Result1 *quotedprintable.Writer
		}
		Sequence   uint32
...
func (m *MoqNewWriter_genType) Mock() NewWriter_genType {
	return func(w io.Writer) *quotedprintable.Writer {
		m.Scene.T.Helper()
...
func (m *MoqNewWriter_genType_mock) Fn(w io.Writer) (result1 *quotedprintable.Writer) {
...
func (r *MoqNewWriter_genType_fnRecorder) ReturnResults(result1 *quotedprintable.Writer) *MoqNewWriter_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
