...
// The following type assertion assures that quotedprintable.Writer_starGenType
...
func (m *MoqWriter_starGenType) Reset() { m.ResultsByParams_Write = nil; m.ResultsByParams_Close = nil }
