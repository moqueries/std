...
type New_genType func(text string) error
...
type MoqNew_genType_params struct{ Text string }
...
func (m *MoqNew_genType) Mock() New_genType {
	return func(text string) error { m.Scene.T.Helper(); moq := &MoqNew_genType_mock{Moq: m}; return moq.Fn(text) }
}

func (m *MoqNew_genType_mock) Fn(text string) (result1 error) {
...
func (m *MoqNew_genType) OnCall(text string) *MoqNew_genType_fnRecorder {
...
func (a *MoqNew_genType_anyParams) Text() *MoqNew_genType_fnRecorder {
...
func (r *MoqNew_genType_fnRecorder) ReturnResults(result1 error) *MoqNew_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqNew_genType) PrettyParams(params MoqNew_genType_params) string {
	return fmt.Sprintf("New_genType(%#v)", params.Text)
}
