...
type MoqStrings_genType struct {
	Scene  *moq.Scene
	Config moq.Config
	Moq    *MoqStrings_genType_mock

	ResultsByParams []MoqStrings_genType_resultsByParams
...
// MoqStrings_genType_mock isolates the mock interface of the Strings_genType
// type
type MoqStrings_genType_mock struct {
	Moq *MoqStrings_genType
}
...
// parameters for the Strings_genType type
type MoqStrings_genType_resultsByParams struct {
	AnyCount  int
	AnyParams uint64
	Results   map[MoqStrings_genType_paramsKey]*MoqStrings_genType_results
}
...
type MoqStrings_genType_results struct {
	...
	Results []struct {
		Values     *struct{}
		Sequence   uint32
		DoFn       MoqStrings_genType_doFn
		DoReturnFn MoqStrings_genType_doReturnFn
	}
	Index  uint32
	Repeat *moq.RepeatVal
}

// MoqStrings_genType_fnRecorder routes recorded function calls to the
// MoqStrings_genType moq
type MoqStrings_genType_fnRecorder struct {
	Params    MoqStrings_genType_params
	AnyParams uint64
	Sequence  bool
	Results   *MoqStrings_genType_results
	Moq       *MoqStrings_genType
}

// MoqStrings_genType_anyParams isolates the any params functions of the
// Strings_genType type
type MoqStrings_genType_anyParams struct {
	Recorder *MoqStrings_genType_fnRecorder
}

// NewMoqStrings_genType creates a new moq of the Strings_genType type
func NewMoqStrings_genType(scene *moq.Scene, config *moq.Config) *MoqStrings_genType {
	if config == nil {
		config = &moq.Config{}
	}
	m := &MoqStrings_genType{
		Scene:  scene,
		Config: *config,
		Moq:    &MoqStrings_genType_mock{},
...
func (r *MoqStrings_genType_fnRecorder) Any() *MoqStrings_genType_anyParams {
...
func (r *MoqStrings_genType_fnRecorder) Seq() *MoqStrings_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqStrings_genType_fnRecorder) NoSeq() *MoqStrings_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqStrings_genType_fnRecorder) ReturnResults() *MoqStrings_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqStrings_genType_fnRecorder) AndDo(fn MoqStrings_genType_doFn) *MoqStrings_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
...
func (r *MoqStrings_genType_fnRecorder) DoReturnResults(fn MoqStrings_genType_doReturnFn) *MoqStrings_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqStrings_genType_fnRecorder) FindResults() {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
	...
	insertAt := -1
	var results *MoqStrings_genType_resultsByParams
	...
	if results == nil {
		results = &MoqStrings_genType_resultsByParams{
			AnyCount:  anyCount,
	...
	if !ok {
		r.Results = &MoqStrings_genType_results{
			Params:  r.Params,
			Results: nil,
			Index:   0,
			Repeat:  &moq.RepeatVal{},
...
func (r *MoqStrings_genType_fnRecorder) Repeat(repeaters ...moq.Repeater) *MoqStrings_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
...
func (m *MoqStrings_genType) Reset() { m.ResultsByParams = nil }

// AssertExpectationsMet asserts that all expectations have been met
func (m *MoqStrings_genType) AssertExpectationsMet() {
	m.Scene.T.Helper()
