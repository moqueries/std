...
type Encode_genType func(w io.Writer, m image.Image, o *gif.Options) error
...
type MoqEncode_genType_doFn func(w io.Writer, m image.Image, o *gif.Options)

// MoqEncode_genType_doReturnFn defines the type of function needed when
// calling DoReturnResults for the Encode_genType type
type MoqEncode_genType_doReturnFn func(w io.Writer, m image.Image, o *gif.Options) error
...
func (m *MoqEncode_genType) Mock() Encode_genType {
	return func(w io.Writer, param2 image.Image, o *gif.Options) error {
		m.Scene.T.Helper()
...
func (m *MoqEncode_genType_mock) Fn(w io.Writer, param2 image.Image, o *gif.Options) (result1 error) {
...
func (m *MoqEncode_genType) OnCall(w io.Writer, param2 image.Image, o *gif.Options) *MoqEncode_genType_fnRecorder {
