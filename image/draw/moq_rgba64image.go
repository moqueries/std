...
// The following type assertion assures that draw.RGBA64Image is mocked
// completely
var _ draw.RGBA64Image = (*MoqRGBA64Image_mock)(nil)
...
type MoqRGBA64Image struct {
	...
	ResultsByParams_Set        []MoqRGBA64Image_Set_resultsByParams
	ResultsByParams_SetRGBA64  []MoqRGBA64Image_SetRGBA64_resultsByParams
...
// MoqRGBA64Image_Set_params holds the params of the RGBA64Image type
type MoqRGBA64Image_Set_params struct {
	X, Y int
	C    color.Color
}

// MoqRGBA64Image_Set_paramsKey holds the map key params of the RGBA64Image
// type
type MoqRGBA64Image_Set_paramsKey struct {
	Params struct {
		X, Y int
		C    color.Color
	}
...
// MoqRGBA64Image_Set_resultsByParams contains the results for a given set of
// parameters for the RGBA64Image type
type MoqRGBA64Image_Set_resultsByParams struct {
	AnyCount  int
	AnyParams uint64
	Results   map[MoqRGBA64Image_Set_paramsKey]*MoqRGBA64Image_Set_results
}

// MoqRGBA64Image_Set_doFn defines the type of function needed when calling
// AndDo for the RGBA64Image type
type MoqRGBA64Image_Set_doFn func(x, y int, c color.Color)

// MoqRGBA64Image_Set_doReturnFn defines the type of function needed when
// calling DoReturnResults for the RGBA64Image type
type MoqRGBA64Image_Set_doReturnFn func(x, y int, c color.Color)

// MoqRGBA64Image_Set_results holds the results of the RGBA64Image type
type MoqRGBA64Image_Set_results struct {
	Params  MoqRGBA64Image_Set_params
	Results []struct {
		Values     *struct{}
		Sequence   uint32
		DoFn       MoqRGBA64Image_Set_doFn
		DoReturnFn MoqRGBA64Image_Set_doReturnFn
	}
	Index  uint32
	Repeat *moq.RepeatVal
}

// MoqRGBA64Image_Set_fnRecorder routes recorded function calls to the
// MoqRGBA64Image moq
type MoqRGBA64Image_Set_fnRecorder struct {
	Params    MoqRGBA64Image_Set_params
	AnyParams uint64
	Sequence  bool
	Results   *MoqRGBA64Image_Set_results
	Moq       *MoqRGBA64Image
}

// MoqRGBA64Image_Set_anyParams isolates the any params functions of the
// RGBA64Image type
type MoqRGBA64Image_Set_anyParams struct {
	Recorder *MoqRGBA64Image_Set_fnRecorder
}

// MoqRGBA64Image_SetRGBA64_params holds the params of the RGBA64Image type
type MoqRGBA64Image_SetRGBA64_params struct {
	X, Y int
	C    color.RGBA64
}

// MoqRGBA64Image_SetRGBA64_paramsKey holds the map key params of the
// RGBA64Image type
type MoqRGBA64Image_SetRGBA64_paramsKey struct {
	Params struct {
		X, Y int
		C    color.RGBA64
	}
...
// MoqRGBA64Image_SetRGBA64_resultsByParams contains the results for a given
// set of parameters for the RGBA64Image type
type MoqRGBA64Image_SetRGBA64_resultsByParams struct {
	AnyCount  int
	AnyParams uint64
	Results   map[MoqRGBA64Image_SetRGBA64_paramsKey]*MoqRGBA64Image_SetRGBA64_results
}

// MoqRGBA64Image_SetRGBA64_doFn defines the type of function needed when
// calling AndDo for the RGBA64Image type
type MoqRGBA64Image_SetRGBA64_doFn func(x, y int, c color.RGBA64)

// MoqRGBA64Image_SetRGBA64_doReturnFn defines the type of function needed when
// calling DoReturnResults for the RGBA64Image type
type MoqRGBA64Image_SetRGBA64_doReturnFn func(x, y int, c color.RGBA64)

// MoqRGBA64Image_SetRGBA64_results holds the results of the RGBA64Image type
type MoqRGBA64Image_SetRGBA64_results struct {
	Params  MoqRGBA64Image_SetRGBA64_params
	Results []struct {
		Values     *struct{}
		Sequence   uint32
		DoFn       MoqRGBA64Image_SetRGBA64_doFn
		DoReturnFn MoqRGBA64Image_SetRGBA64_doReturnFn
	}
	Index  uint32
	Repeat *moq.RepeatVal
}

// MoqRGBA64Image_SetRGBA64_fnRecorder routes recorded function calls to the
// MoqRGBA64Image moq
type MoqRGBA64Image_SetRGBA64_fnRecorder struct {
	Params    MoqRGBA64Image_SetRGBA64_params
	AnyParams uint64
	Sequence  bool
	Results   *MoqRGBA64Image_SetRGBA64_results
	Moq       *MoqRGBA64Image
}

// MoqRGBA64Image_SetRGBA64_anyParams isolates the any params functions of the
// RGBA64Image type
type MoqRGBA64Image_SetRGBA64_anyParams struct {
	Recorder *MoqRGBA64Image_SetRGBA64_fnRecorder
}
...
func (m *MoqRGBA64Image_mock) Set(x, y int, c color.Color) {
	m.Moq.Scene.T.Helper()
	params := MoqRGBA64Image_Set_params{
		X: x,
		Y: y,
	...
	var results *MoqRGBA64Image_Set_results
...
func (m *MoqRGBA64Image_mock) SetRGBA64(x, y int, c color.RGBA64) {
	m.Moq.Scene.T.Helper()
	params := MoqRGBA64Image_SetRGBA64_params{
		X: x,
		Y: y,
	...
	var results *MoqRGBA64Image_SetRGBA64_results
...
func (m *MoqRGBA64Image_recorder) Set(x, y int, c color.Color) *MoqRGBA64Image_Set_fnRecorder {
	return &MoqRGBA64Image_Set_fnRecorder{
		Params: MoqRGBA64Image_Set_params{
			X: x,
			Y: y,
			C: c,
...
func (r *MoqRGBA64Image_Set_fnRecorder) Any() *MoqRGBA64Image_Set_anyParams {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
	...
	return &MoqRGBA64Image_Set_anyParams{Recorder: r}
}

func (a *MoqRGBA64Image_Set_anyParams) X() *MoqRGBA64Image_Set_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqRGBA64Image_Set_anyParams) Y() *MoqRGBA64Image_Set_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqRGBA64Image_Set_anyParams) C() *MoqRGBA64Image_Set_fnRecorder {
	a.Recorder.AnyParams |= 1 << 2
	return a.Recorder
}

func (r *MoqRGBA64Image_Set_fnRecorder) Seq() *MoqRGBA64Image_Set_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqRGBA64Image_Set_fnRecorder) NoSeq() *MoqRGBA64Image_Set_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqRGBA64Image_Set_fnRecorder) ReturnResults() *MoqRGBA64Image_Set_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqRGBA64Image_Set_fnRecorder) AndDo(fn MoqRGBA64Image_Set_doFn) *MoqRGBA64Image_Set_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults must be called before calling AndDo")
		return nil
...
func (r *MoqRGBA64Image_Set_fnRecorder) DoReturnResults(fn MoqRGBA64Image_Set_doReturnFn) *MoqRGBA64Image_Set_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqRGBA64Image_Set_fnRecorder) FindResults() {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Results.Repeat.Increment(r.Moq.Scene.T)
		return
	...
	anyCount := bits.OnesCount64(r.AnyParams)
	insertAt := -1
	var results *MoqRGBA64Image_Set_resultsByParams
	...
	if results == nil {
		results = &MoqRGBA64Image_Set_resultsByParams{
			AnyCount:  anyCount,
			AnyParams: r.AnyParams,
			Results:   map[MoqRGBA64Image_Set_paramsKey]*MoqRGBA64Image_Set_results{},
		}
	...
	r.Results, ok = results.Results[paramsKey]
	if !ok {
		r.Results = &MoqRGBA64Image_Set_results{
			Params:  r.Params,
			Results: nil,
			Index:   0,
			Repeat:  &moq.RepeatVal{},
...
func (r *MoqRGBA64Image_Set_fnRecorder) Repeat(repeaters ...moq.Repeater) *MoqRGBA64Image_Set_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults or DoReturnResults must be called before calling Repeat")
		return nil
...
func (m *MoqRGBA64Image) PrettyParams_Set(params MoqRGBA64Image_Set_params) string {
	return fmt.Sprintf("Set(%#v, %#v, %#v)", params.X, params.Y, params.C)
}

func (m *MoqRGBA64Image) ParamsKey_Set(params MoqRGBA64Image_Set_params, anyParams uint64) MoqRGBA64Image_Set_paramsKey {
	m.Scene.T.Helper()
	var xUsed int
	var xUsedHash hash.Hash
	if anyParams&(1<<0) == 0 {
	...
	return MoqRGBA64Image_Set_paramsKey{
		Params: struct {
			X, Y int
			C    color.Color
		}{
...
func (m *MoqRGBA64Image_recorder) SetRGBA64(x, y int, c color.RGBA64) *MoqRGBA64Image_SetRGBA64_fnRecorder {
	return &MoqRGBA64Image_SetRGBA64_fnRecorder{
		Params: MoqRGBA64Image_SetRGBA64_params{
			X: x,
			Y: y,
			C: c,
...
func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) Any() *MoqRGBA64Image_SetRGBA64_anyParams {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
	...
	return &MoqRGBA64Image_SetRGBA64_anyParams{Recorder: r}
}

func (a *MoqRGBA64Image_SetRGBA64_anyParams) X() *MoqRGBA64Image_SetRGBA64_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqRGBA64Image_SetRGBA64_anyParams) Y() *MoqRGBA64Image_SetRGBA64_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqRGBA64Image_SetRGBA64_anyParams) C() *MoqRGBA64Image_SetRGBA64_fnRecorder {
	a.Recorder.AnyParams |= 1 << 2
	return a.Recorder
}

func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) Seq() *MoqRGBA64Image_SetRGBA64_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) NoSeq() *MoqRGBA64Image_SetRGBA64_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
...
func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) ReturnResults() *MoqRGBA64Image_SetRGBA64_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) AndDo(fn MoqRGBA64Image_SetRGBA64_doFn) *MoqRGBA64Image_SetRGBA64_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults must be called before calling AndDo")
		return nil
...
func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) DoReturnResults(fn MoqRGBA64Image_SetRGBA64_doReturnFn) *MoqRGBA64Image_SetRGBA64_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) FindResults() {
	r.Moq.Scene.T.Helper()
	if r.Results != nil {
		r.Results.Repeat.Increment(r.Moq.Scene.T)
		return
	...
	anyCount := bits.OnesCount64(r.AnyParams)
	insertAt := -1
	var results *MoqRGBA64Image_SetRGBA64_resultsByParams
	...
	if results == nil {
		results = &MoqRGBA64Image_SetRGBA64_resultsByParams{
			AnyCount:  anyCount,
			AnyParams: r.AnyParams,
			Results:   map[MoqRGBA64Image_SetRGBA64_paramsKey]*MoqRGBA64Image_SetRGBA64_results{},
		}
	...
	r.Results, ok = results.Results[paramsKey]
	if !ok {
		r.Results = &MoqRGBA64Image_SetRGBA64_results{
			Params:  r.Params,
			Results: nil,
			Index:   0,
			Repeat:  &moq.RepeatVal{},
...
func (r *MoqRGBA64Image_SetRGBA64_fnRecorder) Repeat(repeaters ...moq.Repeater) *MoqRGBA64Image_SetRGBA64_fnRecorder {
	r.Moq.Scene.T.Helper()
	if r.Results == nil {
		r.Moq.Scene.T.Fatalf("ReturnResults or DoReturnResults must be called before calling Repeat")
		return nil
...
func (m *MoqRGBA64Image) PrettyParams_SetRGBA64(params MoqRGBA64Image_SetRGBA64_params) string {
	return fmt.Sprintf("SetRGBA64(%#v, %#v, %#v)", params.X, params.Y, params.C)
}

func (m *MoqRGBA64Image) ParamsKey_SetRGBA64(params MoqRGBA64Image_SetRGBA64_params, anyParams uint64) MoqRGBA64Image_SetRGBA64_paramsKey {
	m.Scene.T.Helper()
	var xUsed int
	var xUsedHash hash.Hash
	if anyParams&(1<<0) == 0 {
	...
	return MoqRGBA64Image_SetRGBA64_paramsKey{
		Params: struct {
			X, Y int
			C    color.RGBA64
		}{
