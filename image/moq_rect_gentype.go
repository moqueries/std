...
type Rect_genType func(x0, y0, x1, y1 int) image.Rectangle
...
type MoqRect_genType struct {
	...
	Runtime struct {
		ParameterIndexing struct {
			X0 moq.ParamIndexing
			Y0 moq.ParamIndexing
...
type MoqRect_genType_params struct{ X0, Y0, X1, Y1 int }

// MoqRect_genType_paramsKey holds the map key params of the Rect_genType type
type MoqRect_genType_paramsKey struct {
	Params struct{ X0, Y0, X1, Y1 int }
	Hashes struct{ X0, Y0, X1, Y1 hash.Hash }
}
...
func NewMoqRect_genType(scene *moq.Scene, config *moq.Config) *MoqRect_genType {
	...
	m := &MoqRect_genType{
		...
		Runtime: struct {
			...
			X0: moq.ParamIndexByValue,
			Y0: moq.ParamIndexByValue,
			X1: moq.ParamIndexByValue,
			Y1: moq.ParamIndexByValue,
		}},
	}
	m.Moq.Moq = m
...
func (m *MoqRect_genType) Mock() Rect_genType {
	return func(x0, y0, x1, y1 int) image.Rectangle {
		m.Scene.T.Helper()
		moq := &MoqRect_genType_mock{Moq: m}
		return moq.Fn(x0, y0, x1, y1)
	}
}

func (m *MoqRect_genType_mock) Fn(x0, y0, x1, y1 int) (result1 image.Rectangle) {
	...
	if result.DoReturnFn != nil {
		result1 = result.DoReturnFn(x0, y0, x1, y1)
	}
	return
}

func (m *MoqRect_genType) OnCall(x0, y0, x1, y1 int) *MoqRect_genType_fnRecorder {
...
func (a *MoqRect_genType_anyParams) X0() *MoqRect_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 0
	return a.Recorder
}

func (a *MoqRect_genType_anyParams) Y0() *MoqRect_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 1
	return a.Recorder
}

func (a *MoqRect_genType_anyParams) X1() *MoqRect_genType_fnRecorder {
	a.Recorder.AnyParams |= 1 << 2
	return a.Recorder
}

func (a *MoqRect_genType_anyParams) Y1() *MoqRect_genType_fnRecorder {
...
func (r *MoqRect_genType_fnRecorder) ReturnResults(result1 image.Rectangle) *MoqRect_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqRect_genType) PrettyParams(params MoqRect_genType_params) string {
	return fmt.Sprintf("Rect_genType(%#v, %#v, %#v, %#v)", params.X0, params.Y0, params.X1, params.Y1)
}

func (m *MoqRect_genType) ParamsKey(params MoqRect_genType_params, anyParams uint64) MoqRect_genType_paramsKey {
	m.Scene.T.Helper()
	var x0Used int
	var x0UsedHash hash.Hash
	if anyParams&(1<<0) == 0 {
		if m.Runtime.ParameterIndexing.X0 == moq.ParamIndexByValue {
			x0Used = params.X0
		} else {
			x0UsedHash = hash.DeepHash(params.X0)
		}
	}
	var y0Used int
	var y0UsedHash hash.Hash
	if anyParams&(1<<1) == 0 {
		if m.Runtime.ParameterIndexing.Y0 == moq.ParamIndexByValue {
			y0Used = params.Y0
		} else {
			y0UsedHash = hash.DeepHash(params.Y0)
		}
	}
	var x1Used int
	var x1UsedHash hash.Hash
	if anyParams&(1<<2) == 0 {
		if m.Runtime.ParameterIndexing.X1 == moq.ParamIndexByValue {
			x1Used = params.X1
		} else {
	...
	if anyParams&(1<<3) == 0 {
		if m.Runtime.ParameterIndexing.Y1 == moq.ParamIndexByValue {
			y1Used = params.Y1
		} else {
