...
type Open_genType func(path string) (*plugin.Plugin, error)
...
type MoqOpen_genType_params struct{ Path string }
...
func (m *MoqOpen_genType) Mock() Open_genType {
	return func(path string) (*plugin.Plugin, error) {
		m.Scene.T.Helper()
...
func (m *MoqOpen_genType_mock) Fn(path string) (result1 *plugin.Plugin, result2 error) {
...
func (m *MoqOpen_genType) OnCall(path string) *MoqOpen_genType_fnRecorder {
...
func (r *MoqOpen_genType_fnRecorder) ReturnResults(result1 *plugin.Plugin, result2 error) *MoqOpen_genType_fnRecorder {
	r.Moq.Scene.T.Helper()
	r.FindResults()
...
func (m *MoqOpen_genType) PrettyParams(params MoqOpen_genType_params) string {
	return fmt.Sprintf("Open_genType(%#v)", params.Path)
}
